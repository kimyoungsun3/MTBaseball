	        			...
	        			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
	        				...
	        				<tr>
	        					<td colspan=3>
	        						<font color=red>
	        							...
	        							2. 보물 선물에 주의<br>
	        							&nbsp;&nbsp;a)장갑(80010) x 0강 > 80010 x 0<br>
	        							&nbsp;&nbsp;c)장갑(80010) x 7강 > 80010 x 7<br>
	        							&nbsp;&nbsp;d)장갑(80010) x 1강 (보유) + 0강한개 획득 > x 2강이됨
	        						</font>
	        					</td>
	        				</tr>
	        				<tr>
	        				...
	        				<tr>
	        					...
	        					<select name="itemcode">
									<%
									//2. 데이타 조작
									//exec spu_FVFarmD 27, 1,  -1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''							-- 선물 가능한 리스트
									...
									<%while(result.next()){%>
										<option value="<%=result.getString("itemcode")%>">
											...
											<%=result.getInt("category")==80?("/ "+result.getString("description")):""%>
											<br>
										</option>
									<%}%>
								</select>
	        				...
	        				<tr>
	        					<td>수량</td>
	        					<td>
	        						<input name="cnt" type="text" value="1" maxlength="12" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;width:154px;">
	        						(수량 맥스는 천억까지만 지원됩니다.)
	        					</td>
	        				</tr>
	        				</tbody></table>
