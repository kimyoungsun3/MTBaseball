...
<%
	...
	String urls[] = {
					"market://details?id=com.marbles.farmvill4gg",		"GOOGLE",
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
	<tr>
		<td colspan=2 align=center>
			...
			%>
			<br>
        	<font size=5 color=blue>짜요 전송대기: Android:<%=cnt3%>건 / <%=1*cnt3/100%>초, iPhone:<%=cnt4%>건 / <%=1*cnt4/100%>초</font><br><br>
        	<font size=5 color=blue>외전 전송대기: Android:<%=cnt%>건 / <%=1*cnt/100%>초, iPhone:<%=cnt2%>건 / <%=1*cnt2/100%>초</font><br><br>
        	<font size=5 color=blue>외전2 전용 푸쉬가 존재안함.</font><br><br>
	...
	<tr>
        ...
        <td align="center" style="vertical-align:middle;">
        	<table border="0">
	        	...
	        	<input type="hidden" name="personal" value="<%=personal%>">
	        	<tr>
        			<td align="center">짜요(외전)Kakao 한명의 유저에게 URL 푸쉬</td>
        		</tr>
	        	<tr>
        			<td align="center">유저:<input name="gameid" type="text" value="<%=gameid%>" maxlength="60" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;width:400px;"></td>
        		</tr>
	...
	<tr>
        ...
        <td align="center" style="vertical-align:middle;">
        	<table border="0">
	        	...
	        	<tr>
        			<td align="center">
        				<font color=blue>짜요Data -> 짜요, 외전(Push) -> 양들의 목장(K4)단체 URL 푸쉬 </font> <br>짜요 유저들을 뺏어와서 양들의 목장 유저로 만들고 싶을때 이용하세요.
        			</td>
        		</tr>
				<tr>
					<td>푸쉬서버종류
        ...
        <td align="center" style="vertical-align:middle;">
        	<table border="0">
	        	...
	        	<tr>
        			<td align="center"><font color=red>양들의 목장(K4) 유저들에게 단체 푸쉬 > 바로실행</font></td>
        		</tr>
				<tr>
					<td>푸쉬서버종류
						<select name="p5">
