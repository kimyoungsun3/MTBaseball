			...
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				...
				<table>
					...
					<tr>
						<td>마켓</td>
						<td>
							SKT(1), GOOGLE(5), NHN(6), IPHONE(7)은 구분된다.<br>
				...
				<table border=1>
					<tr>
						<td colspan=15>
							...
							원칙4. SKT(1), GOOGLE(5), NHN(6), IPHONE(7)</font>
						</td>
					</tr>
					<tr>
						<td></td>
						...
						<td bgcolor=skyblue>회전판무료돌리기</td>
						<td bgcolor=yellow>복귀</td>
						<td colspan=2></td>
					</tr>
					<%if(cstmt.getMoreResults()){
						result = cstmt.getResultSet();
						...
						<tr>
								...
								<td>
									<input name="d2" type="text" value="<%=result.getInt("roulani1")%>" size="5" maxlength="5" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;"><br>
									<input name="d5" type="text" value="<%=result.getInt("roulreward1")%>" size="5" maxlength="5" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;">
									...
									<input name="ps4" type="text" value="<%=result.getString("roulname1")%>" size="20" maxlength="20" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;"><br>
									<img src=<%=imgroot%>/<%=result.getInt("roulani1")%>.png> -> <img src=<%=imgroot%>/<%=result.getInt("roulreward1")%>.png>
								</td>
								<td>
									<input name="d3" type="text" value="<%=result.getInt("roulani2")%>" size="5" maxlength="5" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;"><br>
									<input name="d6" type="text" value="<%=result.getInt("roulreward2")%>" size="5" maxlength="5" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;">
									...
									<input name="ps5" type="text" value="<%=result.getString("roulname2")%>" size="20" maxlength="20" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;"><br>
									<img src=<%=imgroot%>/<%=result.getInt("roulani2")%>.png> -> <img src=<%=imgroot%>/<%=result.getInt("roulreward2")%>.png>
								</td>
								<td>
									<input name="d4" type="text" value="<%=result.getInt("roulani3")%>" size="5" maxlength="5" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;"><br>
									<input name="d7" type="text" value="<%=result.getInt("roulreward3")%>" size="5" maxlength="5" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;">
									...
									<input name="ps6" type="text" value="<%=result.getString("roulname3")%>" size="20" maxlength="20" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;"><br>
									<img src=<%=imgroot%>/<%=result.getInt("roulani3")%>.png> -> <img src=<%=imgroot%>/<%=result.getInt("roulreward3")%>.png>
								</td>
								...
								<td <%=getCheckValueOri(result.getInt("wheelgauageflag"), -1, "bgcolor=#aaaaaa", "")%>>
									...
									point:<input name="d28" type="text" value="<%=result.getInt("wheelgauagepoint")%>" size="3" maxlength="3" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;"><br>
									max:<input name="d29" type="text" value="<%=result.getInt("wheelgauagemax")%>" size="3" maxlength="3" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;"><br>
									<font color=red>Max는 100고정</font>
								</td>
								<td <%=getCheckValueOri(result.getInt("rtnflag"), -1, "bgcolor=#aaaaaa", "")%>>
									<select name="d30" >
										<option value="-1" <%=getSelect(result.getInt("rtnflag"), -1)%>>비활성(-1)</option>
										<option value="1"  <%=getSelect(result.getInt("rtnflag"),  1)%>>활성(1)</option>
									</select><br>
								</td>
								<td>
