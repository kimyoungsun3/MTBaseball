		...
		<td align="center">
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					<tr>
						<td colspan=4>
							환생 순위 100위 랭킹 <a href=userrank_mas2.jsp><img src=images/refresh2.png alt="화면갱신"></a>
						</td>
					</tr>
				</table>
				<table border=1>
					<%
					//2. 데이타 조작
					//exec spu_FVFarmD 19, 98, -1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''						-- 지난 랭킹일
					...
					<%while(result.next()){%>
						<tr>
							...
							<td><a href=userrank_list3.jsp?dateid=<%=result.getString("dateid")%> target=_blank>보기</a></td>
						</tr>
					<%}%>
				</table>
			</div>
