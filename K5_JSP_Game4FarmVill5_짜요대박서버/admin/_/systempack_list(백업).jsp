		...
		<td align="center">
			...
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					...
					<tr>
						<td>
							캐쉬:<input name="p6" type="text" value="30" size="4" maxlength="5" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;">
							활인:<input name="p7" type="text" value="0" size="4" maxlength="5" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;">(%)
						</td>
					</tr>
					<tr>
						<td>
								...
								<tr <%=getCheckValueOri(result.getInt("packstate"), -1, "bgcolor=#aaaaaa", "")%> <%=getCheckValueOri(result.getInt("idx"), idx, "bgcolor=#ffe020", "")%> >
									...
									<td>
										<table>
											...
											<tr>
												<%for(int i = 0; i < 5; i++){%>
													<td><img src=item/<%=result.getInt("pack" + (i+1))%>.png></td>
												<%}%>
											</tr>
										</table>
									</td>
