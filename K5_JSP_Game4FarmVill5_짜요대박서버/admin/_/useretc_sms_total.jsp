...
<table>
	...
	<tr>
		<td align="center">
			<form name="GIFTFORM" method="post" action="useretc_sms_total.jsp" onsubmit="return f_Submit(this);">
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				...
				<table border=1>
					...
					<%while(result.next()){%>
						<tr>
							<td><a href=useretc_sms_total.jsp?dateid=<%=result.getString("dateid")%>><%=result.getString("dateid")%></a></td>
							<td><%=result.getString("cnt")%></td>
							<td><%=result.getString("cnt2")%></td>
