...
<table>
	...
	<tr>
		<td align="center">
			<form name="GIFTFORM" method="post" action="useretc_genreward_total.jsp" onsubmit="return f_Submit(this);">
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				...
				<table border=1>
					<%
					//2. 데이타 조작
					//exec spu_FarmD 26, -1, -1, 401, -1, -1, -1, -1, -1, -1, '', '', '', '', ''			--SMS list
					//exec spu_FarmD 26, -1, -1, 401, -1, -1, -1, -1, -1, -1, '', '20130204', '', '', ''		--SMS list(검색)
					...
					<%while(result.next()){%>
						<tr>
							<td><a href=useretc_genreward_total.jsp?dateid=<%=result.getString("dateid")%>><%=result.getString("dateid")%></a></td>
