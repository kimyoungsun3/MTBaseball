...
<table>
	...
	<tr>
		<td align="center">
			<form name="GIFTFORM" method="post" action="itembuypromotion_list.jsp" onsubmit="return f_Submit(this);">
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					<tr>
						<td colspan=4>
							아이템 일별 구매내역<br>
							일자검색을 하면 세부내역 최신것 200건만 나옵니다.
						</td>
					</tr>
					<tr>
				...
				<table border=1>
					<%
					//2. 데이타 조작
					//exec spu_FarmD 21, -1, -1, 13, -1, -1, -1, -1, -1, -1, '', '', '', '', ''		--아이템구매프로모션(13)
					...
					<%while(result.next()){%>
						<tr>
							...
							<td><a href=itembuypromotion_list.jsp?dateid=<%=result.getString("dateid")%>><%=result.getString("dateid")%></a></td>
