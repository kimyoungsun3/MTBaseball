...
<table>
	...
	<tr>
		<td align="center">
			<form name="GIFTFORM" method="post" action="statistics_country.jsp" onsubmit="return f_Submit(this);">
				...
				<table border=1>
					...
					<%while(result.next()){%>
						<tr>
							...
							<td><a href=statistics_country.jsp?dateid=<%=result.getString("dateid")%>><%=result.getString("dateid")%></a></td>
							<td><%=result.getString("btwin")%></td>
							<td><%=result.getString("bttotal")%></td>
						</tr>
					<%}%>
				</table>
