			...
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					<tr>
						...
						<td>선물자<input name="giftid" type="text" value="<%=giftid%>" maxlength="60" tabindex="1" style="border:1px solid #EBEBEB;background:#FFFFFF;width:154px;"></td>
						<td rowspan="2" style="padding-left:5px;"><input name="image" type="image" src="images/btn_send.gif" border="0" tabindex="3"></td>
						<td rowspan="2" style="padding-left:5px;"><a href="wgiftsend_form.jsp">선물하기</a></td>
					</tr>
					<tr>
						<td colspan=5>
