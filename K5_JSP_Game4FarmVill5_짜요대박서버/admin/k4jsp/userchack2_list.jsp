		...
		<td align="center">
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					<tr>
						<td colspan=4>
							무과금, 2만 VIP보유<a href=userchack2_list.jsp><img src=images/refresh2.png alt="화면갱신"></a>(기록안함과 블럭 유저는 안나옴)
						</td>
					</tr>
				</table>
				<table border=1>
					...
					%>
						<tr>
							...
							<td>bestani</td>
							<td>salemoney2</td>
							<td>cashpoint/cashcost/vippoint</td>
					...
					<%while(result.next()){%>
						<tr>
							...
							<td><%=result.getString("salemoney")%></td>
							<td>
							...
							<td><a href=userinfo_list.jsp?gameid=<%=result.getString("gameid")%> target=_blank>보기</a></td>
						</tr>
					<%}%>
				</table>
			</div>
