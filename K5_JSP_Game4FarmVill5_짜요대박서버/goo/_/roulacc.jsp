...
<%
	...
	try{
		//2. 데이타 조작
		//exec spu_RoulAcc 'xxxx2', '049000s1i0n7t8445289', -1	-- 악세뽑기
		query.append("{ call dbo.spu_RoulAcc (?, ?, ?)} ");
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_ROULACC); 						msg.append("</code>\n");
		...
		msg.append("		<itemcode4>");		msg.append(result.getString("itemcode4"));    	msg.append("</itemcode4>\n");
		msg.append("		<itemcode5>");		msg.append(result.getString("itemcode5"));    	msg.append("</itemcode5>\n");
		msg.append("	</result>\n");
