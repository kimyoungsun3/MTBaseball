...
<%
	...
	try{
		...
		//2. 데이타 조작
		//exec spu_ItemAcc 'xxxx2', '049000s1i0n7t8445289',  1, 16, 17, -1	-- 1번동물에 12번악세를 머리, 13번악세를 옆구리
		query.append("{ call dbo.spu_ItemAcc (?, ?, ?, ?, ?, ?)} ");
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_ITEMACC); 						msg.append("</code>\n");
