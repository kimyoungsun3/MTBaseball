...
<%
	...
	String kakaouseridfd= util.getParamStr(request, "kakaouseridfd", "");
	/////////////////////////////////////////////////////////////////////
	//		파라미터 받기
	/////////////////////////////////////////////////////////////////////
	if(DEBUG_LOG_PARAM){
		...
		DEBUG_LOG_STR.append("\r\n mode="		+ mode);
		DEBUG_LOG_STR.append("\r\n nickname=" 	+ nickname);
		DEBUG_LOG_STR.append("\r\n kakaouseridfd=" 	+ kakaouseridfd);
		System.out.println(DEBUG_LOG_STR.toString());
	}
	//out.print( gameid + " " + password  + " " +  nickname);
	...
	try{
		...
		//exec spu_FVNickName 'xxxx2',  '049000s1i0n7t8445289', 1, '테스인원', -1
		query.append("{ call dbo.spu_FVNickName2 (?, ?, ?, ?, ?, ?)} ");
		cstmt = conn.prepareCall(query.toString());
		cstmt.setString(idx++, gameid);
		cstmt.setString(idx++, password);
		cstmt.setString(idx++, mode);
		cstmt.setString(idx++, nickname);
		cstmt.setString(idx++, kakaouseridfd);
		...
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_NICKNAME); 				msg.append("</code>\n");
