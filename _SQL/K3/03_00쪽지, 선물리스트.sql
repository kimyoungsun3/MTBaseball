/*
update dbo.tFVGiftList set giftdate = getdate() - 29 where idx = 441
update dbo.tFVGiftList set giftdate = getdate() - 30 where idx = 442
update dbo.tFVGiftList set giftdate = getdate() - 31 where idx = 443
select * from dbo.tFVGiftList where gameid = 'xxxx2' and giftkind in (1, 2)
