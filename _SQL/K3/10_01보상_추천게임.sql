/*
-- select * from dbo.tFVSysRecommendLog where gameid = 'xxxx2'
-- select * from dbo.tFVGiftList where gameid = 'xxxx2'
-- delete from dbo.tFVSysRecommendLog where gameid = 'xxxx2'
-- delete from dbo.tFVGiftList where gameid = 'xxxx2'

exec spu_FVGameReward 'xxxx2', '049000s1i0n7t8445289', 1, 7773, -1
exec spu_FVGameReward 'xxxx2', '049000s1i0n7t8445289', 2, 7774, -1
exec spu_FVGameReward 'xxxx2', '049000s1i0n7t8445289', 3, 7775, -1
*/
use Game4FarmVill3
GO
...
Begin
	...
	ELSE
		BEGIN
			...
			-- 통계정보기록.
			--------------------------------------------------
			exec spu_FVDayLogInfoStatic @market, 110, 1			-- 일 게임 무료충전카운터.(배너형태)
		END
