...
while (@loop < 100)
	begin
		update dbo.tFVUserMaster set kakaomsginvitecnt = @loop, kakaomsginvitetodaycnt = 0, kakaomsginvitetodaydate = kakaomsginvitetodaydate - 1 	where gameid = 'xxxx2'
...
as
	...
	declare @kakaoinvite01		int				set @kakaoinvite01 		= 3400	--5명 	: 일반 동물 구매권 5매
	declare @kakaoinvite02		int				set @kakaoinvite02 		= 3400	--10명 	: 일반 동물 구매권 10매
	declare @kakaoinvite03		int				set @kakaoinvite03 		= 3015	--20명 	: 캐쉬 100	1000원
	declare @kakaoinvite04		int				set @kakaoinvite04		= 3500	--40명 	: 프리미엄 구매권 2매	3000원
	declare @kakaoinvitecnt01	int				set @kakaoinvitecnt01 	= 5
	declare @kakaoinvitecnt02	int				set @kakaoinvitecnt02 	= 10
	declare @kakaoinvitecnt03	int				set @kakaoinvitecnt03 	= 100
	declare @kakaoinvitecnt04	int				set @kakaoinvitecnt04	= 2
Begin
	------------------------------------------------
	--	3-1. 초기화
	------------------------------------------------
		...
		begin
			...
			if(@giftcode != @KAKAO_MSG_INVITE_STEP0_NON)
				begin
					...
					exec spu_FVSubGiftSend 2, @giftcode, @cnt, '초대보상', @gameid_, ''
				end
			...
			--------------------------------------------------------------
			set @giftcode = @KAKAO_MSG_INVITE_STEP0_NON
			exec spu_FVSubGiftSend 2, 3300, 5, '초대보상', @gameid_, ''
