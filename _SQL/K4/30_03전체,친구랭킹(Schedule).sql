...
-- use Game4FarmVill4
-- GO
-- update dbo.tFVUserMaster set salemoney = 123456789000 where gameid = 'xxxx' update dbo.tFVUserMaster set salemoney = 123456789002 where gameid = 'xxxx2' update dbo.tFVUserMaster set salemoney = 123456789003 where gameid = 'xxxx3'
		...
		while @@Fetch_status = 0
			Begin
				...
				if(@rank >= 1 and @rank <=  5)
					...
					begin
						exec spu_FVSubGiftSend 2, 3015,   7000, @sendid, @gameid, ''
					...
					begin
						...
						exec spu_FVSubGiftSend 2, 3700,     10, @sendid, @gameid, ''
					end
				else if(          @rank <= 100)
					begin
