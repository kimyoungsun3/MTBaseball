/*
exec spu_FVChangeInfo 'xxxx2', '049000s1i0n7t8445289', 11, -1		-- 푸쉬승인/거절

--select kakaomsgblocked from dbo.tFVUserMaster where gameid = 'xxxx2'
exec spu_FVChangeInfo 'xxxx2', '049000s1i0n7t8445289', 12, -1		-- 카카오 메세지 자기것 거부
*/
use Game4FarmVill4
GO
...
Begin
	...
	--select 'DEBUG 입력정보', @gameid_ gameid_, @password_ password_, @mode_ mode_
