--################################################################
/*
-- update dbo.tFVUserMaster set concode = 82 where gameid = 'xxxx2'
-- 쪽지, 선물 기록하기(데일리 보상)
-- 200개까지만 기록하고 나머지는 삭제됨.
exec spu_FVSubGiftSend 1,   -1,   0, 'SysCoup', 'xxxx2', 'message'			-- ?????? ????
exec spu_FVSubGiftSend 2, 3000,  10, 'SysCoup', 'xxxx2', ''					-- 유제품
exec spu_FVSubGiftSend 2, 3100, 100, 'SysCoup', 'xxxx2', ''					-- 코인
