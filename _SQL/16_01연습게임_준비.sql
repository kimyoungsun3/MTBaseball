/*
-- 연습게임.
exec spu_PTReady 'mtxxxx3', '049000s1i0n7t8445289', 333, 0, -1
exec spu_PTReady 'mtxxxx3', '049000s1i0n7t8445289', 3331,0, -1		-- 세션이 만기된경우.
*/
use GameMTBaseball
GO

IF OBJECT_ID ( 'dbo.spu_PTReady', 'P' ) IS NOT NULL
    DROP PROCEDURE dbo.spu_PTReady;
GO

------------------------------------------------
--	1. 프로시져 생성
------------------------------------------------
create procedure dbo.spu_PTReady
...
Begin
	...
	--select 'DEBUG 3-1 입력정보', @gameid_ gameid_, @password_ password_, @sid_ sid_, @gmode_ gmode_
	...
	--select 'DEBUG 3-2 유저정보', @gameid gameid, @blockstate blockstate, @sid sid
