/*
update dbo.tUserMaster set cashcost = 1000 where gameid = 'xxxx2'  update dbo.tUserGameMTBaseball set playcnt = 0 where gameid = 'xxxx2' and itemcode in ( 6900, 6901, 6902 )
