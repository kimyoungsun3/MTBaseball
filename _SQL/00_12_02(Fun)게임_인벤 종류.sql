...
BEGIN
	...
	else if(@category_ in ( @ITEM_SUBCATEGORY_BOX_WEAR, @ITEM_SUBCATEGORY_BOX_PIECE, @ITEM_SUBCATEGORY_BOX_ADVICE, @ITEM_SUBCATEGORY_SCROLL_EVOLUTION, @ITEM_SUBCATEGORY_SCROLL_COMMISSION ) )
		begin
