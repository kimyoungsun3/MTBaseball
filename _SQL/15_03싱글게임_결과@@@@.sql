...
select * from dbo.tSingleGame where gameid = 'mtxxxx3' order by idx desc

update dbo.tUserMaster set battleflag = 1 where gameid = 'mtxxxx3'
exec spu_AniBattleResult 'mtxxxx3', '049000s1i0n7t8445289', 17,  1, 90, 3, -1

update dbo.tUserMaster set battleflag = 1 where gameid = 'mtxxxx3'
exec spu_AniBattleResult 'mtxxxx3', '049000s1i0n7t8445289', 17, -1, 90, 0, -1

update dbo.tUserMaster set battleflag = 1 where gameid = 'mtxxxx3'
exec spu_AniBattleResult 'mtxxxx3', '049000s1i0n7t8445289', 62,  1, 90, 2, -1

update dbo.tUserMaster set battleflag = 1 where gameid = 'mtxxxx3'
exec spu_AniBattleResult 'mtxxxx3', '049000s1i0n7t8445289', 61,  1, 90, 1, -1

update dbo.tUserMaster set battleflag = 1 where gameid = 'mtxxxx3'
exec spu_AniBattleResult 'mtxxxx3', '049000s1i0n7t8445289', 65,  1, 90, 3, -1
*/
use GameMTBaseball
GO
