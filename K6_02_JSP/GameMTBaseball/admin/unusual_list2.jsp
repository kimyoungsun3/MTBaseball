		...
		<td align="center">
			...
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					<tr>
						<td colspan=4>
							유저들이 뽑기, 거래 모니터 <a href=unusual_list2.jsp><img src=images/refresh2.png alt="화면갱신"></a><br>
						</td>
					</tr>
					<tr>
						<td>부정행위정보들</td>
					...
					<%while(result.next()){%>
						<tr>
							...
							<td>
								...
								<a href=usersetting_ok.jsp?p1=19&p2=1007&p3=1&p4=<%=result.getString("idx")%>&ps1=<%=result.getString("gameid")%>&ps2=<%=adminid%>&branch=unusual_list2&gameid=<%=result.getString("gameid")%>>
									삭제
								</a> /
								<a href=usersetting_ok.jsp?p1=19&p2=1007&p3=2&p4=<%=result.getString("idx")%>&ps1=<%=result.getString("gameid")%>&ps2=<%=adminid%>&branch=unusual_list2&gameid=<%=result.getString("gameid")%>>
									전체삭제
								</a>
							</td>
						</tr>
