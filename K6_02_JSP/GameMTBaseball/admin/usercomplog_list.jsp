...
<table>
	...
	<tr>
		<td align="center">
			<form name="GIFTFORM" method="post" action="usercomplog_list.jsp" onsubmit="return f_Submit(this);">
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					<tr>
						<td colspan=4>
							합성 검색하기. <a href=usercomplog_list.jsp><img src=images/refresh2.png alt="화면갱신"></a>
						</td>
					</tr>
					<tr>
						<td>계정</td>
				...
				<table border=1>
					<%
					//2. 데이타 조작
					//exec spu_FarmD 19, 415,-1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''						-- 유저 뽑기리스트
					//exec spu_FarmD 19, 415,-1, -1, -1, -1, -1, -1, -1, -1, 'xxxx2', '', '', '', '', '', '', '', '', ''				--
					...
					<%while(result.next()){%>
						<tr>
							...
							<td>
								<a href=usercomplog_list.jsp?gameid=<%=result.getString("gameid")%>><%=result.getString("gameid")%></a>
							</td>
					...
					<tr>
						<td colspan=17 align=center>
								<a href=usercomplog_list.jsp?idxPage=<%=(idxPage - 1 < 1)?1:(idxPage-1)%>><<</a>
								<%=idxPage%> / <%=maxPage%>
								<a href=usercomplog_list.jsp?idxPage=<%=(idxPage + 1 > maxPage)?maxPage:(idxPage + 1)%>>>></a>
						</td>
					</tr>
