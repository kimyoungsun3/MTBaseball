...
update dbo.tFVUserMaster set cashcost = 1000, randserial = -1 where gameid = 'xxxx2'
exec spu_FVPackBuy 'xxxx2', '049000s1i0n7t8445289', 1, 7777, -1			-- 정상유저
*/
use Farm
GO
...
Begin
	...
	if(@gameid = '')
		...
		BEGIN
			...
			exec spu_FVSubGiftSend @GIFTLIST_GIFT_KIND_GIFT,  @pack5, 'SysPack', @gameid_, ''
			exec spu_FVSubGiftSend @GIFTLIST_GIFT_KIND_GIFT,  @pack4, 'SysPack', @gameid_, ''
			exec spu_FVSubGiftSend @GIFTLIST_GIFT_KIND_GIFT,  @pack3, 'SysPack', @gameid_, ''
			exec spu_FVSubGiftSend @GIFTLIST_GIFT_KIND_GIFT,  @pack2, 'SysPack', @gameid_, ''
			exec spu_FVSubGiftSend @GIFTLIST_GIFT_KIND_GIFT,  @pack1, 'SysPack', @gameid_, ''
