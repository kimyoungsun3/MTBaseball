-----------------------------------------------------------------------
-- exec spu_FVsubAddKakaoFriend 'xxxx2', '0:kakaouseridxxxx;1:kakaouseridxxxx3;'
-- exec spu_FVsubAddKakaoFriend 'xxxx2', '0:x1;1:x2;'
-- SELECT * FROM dbo.fnu_SplitTwoStr(';', ':', '0:x1;1:x2;')
-- SELECT * FROM dbo.fnu_SplitTwoStr(';', ':', '0:kakaouseridxxxx;1:kakaouseridxxxx3;')
-- exec spu_FVsubAddKakaoFriend 'farm1503', '0:88227566776204833;1:88248034712699921;2:88282071099937857;'
-----------------------------------------------------------------------
use Farm
GO

IF OBJECT_ID ( 'dbo.spu_FVsubAddKakaoFriend', 'P' ) IS NOT NULL
    DROP PROCEDURE dbo.spu_FVsubAddKakaoFriend;
GO

create procedure dbo.spu_FVsubAddKakaoFriend
	@gameid_				varchar(60),
