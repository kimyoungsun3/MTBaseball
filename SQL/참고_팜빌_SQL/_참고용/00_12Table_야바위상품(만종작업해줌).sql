...
IF OBJECT_ID (N'dbo.tFVSystemYabau', N'U') IS NOT NULL
	DROP TABLE dbo.tFVSystemYabau;
GO

create table dbo.tFVSystemYabau(
...
IF EXISTS (SELECT name FROM sys.indexes WHERE name = N'idx_tFVSystemYabau_famelvmin_famelvmax')
	DROP INDEX tFVSystemYabau.idx_tFVSystemYabau_famelvmin_famelvmax
GO
CREATE INDEX idx_tFVSystemYabau_famelvmin_famelvmax ON tSystemYabau (famelvmin, famelvmax)
GO


--insert into dbo.tFVSystemYabau(itemcode, famelvmin, famelvmax, saleper, packstate, packname,  comment, pack11, pack12, pack13, pack14, pack21, pack22, pack23, pack24, pack31, pack32, pack33, pack34, pack41, pack42, pack43, pack44, pack51, pack52, pack53, pack54, pack61, pack62, pack63, pack64, packstr)
...
--select * from dbo.tFVSystemYabau order by famelvmin asc, famelvmax asc
