/*
update dbo.tFVUserMaster set cashcost = 1000, tradecnt = 0, prizecnt = 0, tradecntold = 29,  prizecntold =  4 where gameid = 'xxxx2'
update dbo.tFVUserMaster set cashcost = 1000, tradecnt = 0, prizecnt = 0, tradecntold = 30,  prizecntold =  5 where gameid = 'xxxx2'
update dbo.tFVUserMaster set cashcost = 1000, tradecnt = 0, prizecnt = 0, tradecntold = 60,  prizecntold = 10 where gameid = 'xxxx2'
update dbo.tFVUserMaster set cashcost = 1000, tradecnt = 0, prizecnt = 0, tradecntold = 120, prizecntold = 20 where gameid = 'xxxx2'
update dbo.tFVUserMaster set cashcost = 1000, tradecnt = 0, prizecnt = 0, tradecntold = 999, prizecntold = 99 where gameid = 'xxxx2'
exec spu_FVTradeContinue 'xxxx2', '049000s1i0n7t8445289', -1

update dbo.tFVUserMaster set cashcost = 1000, gamecost = 0, tradecnt = 0, prizecnt = 0, tradecntold = 119, prizecntold = 19 where gameid = 'xxxx2'
exec spu_FVTradeContinue 'xxxx2', '049000s1i0n7t8445289', -1
select cashcost, gamecost, tradecnt, prizecnt, tradecntold, prizecntold from dbo.tFVUserMaster where gameid = 'xxxx2'
*/
use Farm
GO

IF OBJECT_ID ( 'dbo.spu_FVTradeContinue', 'P' ) IS NOT NULL
    DROP PROCEDURE dbo.spu_FVTradeContinue;
GO

------------------------------------------------
--	1. 프로시져 생성
------------------------------------------------
create procedure dbo.spu_FVTradeContinue
	@gameid_								varchar(60),
...
Begin
	...
	from
	(select itemcode, cashcost, param1, param2 from dbo.tFVItemInfo where subcategory = @ITEM_SUBCATEGORY_CONTRADE) t
	...
	if(@gameid = '')
		...
		BEGIN
			...
			-- 구매기록마킹
			-----------------------------------
			exec spu_FVUserItemBuyLog @gameid_, @payitemcode, 0, @paycashcost
