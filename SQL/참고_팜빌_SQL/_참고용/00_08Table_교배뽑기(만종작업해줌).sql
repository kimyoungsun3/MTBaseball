...
GO
CREATE INDEX idx_tFVSystemRoulette_famelvmin_famelvmax ON tSystemRoulette (famelvmin, famelvmax)
GO

   delete from dbo.tFVItemInfo where subcategory = 600 and itemcode >= 60004
