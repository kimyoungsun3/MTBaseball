...
select itemcode, itemname, param6 fresh from dbo.tFVItemInfo where category = 1

insert into @tItemExpire2
select itemcode, param5 plusfreshfromin, param7 famelv from dbo.tFVItemInfo where subcategory = 62
