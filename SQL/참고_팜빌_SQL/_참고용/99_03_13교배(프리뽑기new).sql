...
while(@famelv <= 70)
	begin
		...
		while(@curloop <= @loopmax)
			begin
				update dbo.tFVUserMaster set famelv = @famelv, cashcost = 1000000, gamecost = 1000000, heart = 5000000, randserial = -1 where gameid = @gameid_
