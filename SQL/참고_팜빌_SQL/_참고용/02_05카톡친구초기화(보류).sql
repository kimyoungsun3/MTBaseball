/*
exec spu_FVKakaoFriendReset 'xxxx2',  '049000s1i0n7t8445289', '0:kakaouseridxxxx;1:kakaouseridxxxx3;', -1
*/
use Farm
GO

IF OBJECT_ID ( 'dbo.spu_FVKakaoFriendReset', 'P' ) IS NOT NULL
    DROP PROCEDURE dbo.spu_FVKakaoFriendReset;
GO

create procedure dbo.spu_FVKakaoFriendReset
	@gameid_				varchar(60),
		...
		begin
			...
			if(LEN(@kakaouseridlist_) >= 3)
				begin
					...
					exec spu_FVsubAddKakaoFriend @gameid_, @kakaouseridlist_
				end
		end
