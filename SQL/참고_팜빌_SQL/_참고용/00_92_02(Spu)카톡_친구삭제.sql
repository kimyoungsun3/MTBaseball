-----------------------------------------------------------------------
-- exec spu_FVsubDelFriend 'xxxx2'
-----------------------------------------------------------------------
use Farm
GO

IF OBJECT_ID ( 'dbo.spu_FVsubDelFriend', 'P' ) IS NOT NULL
    DROP PROCEDURE dbo.spu_FVsubDelFriend;
GO

create procedure dbo.spu_FVsubDelFriend
	@gameid_				varchar(60)
