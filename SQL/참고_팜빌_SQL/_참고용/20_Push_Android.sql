...
exec spu_FVUserPushMsgAndroid 'guest90586', '5697165c2c6g3u571634', 'guest90586', 1, '단순제목', '단순내용', -1, -1
exec spu_FVUserPushMsgAndroid 'guest90586', '5697165c2c6g3u571634', 'guest90586', 2, '자랑제목', '자랑내용', 5, -1
exec spu_FVUserPushMsgAndroid 'guest90586', '5697165c2c6g3u571634', 'guest90586', 3, 'URL제목', 'http://m.naver.com', -1, -1
*/
use Farm
GO

IF OBJECT_ID ( 'dbo.spu_FVUserPushMsgAndroid', 'P' ) IS NOT NULL
    DROP PROCEDURE dbo.spu_FVUserPushMsgAndroid;
GO

create procedure dbo.spu_FVUserPushMsgAndroid
	@gameid_				varchar(60),
...
Begin
	...
	select
		...
		@recemarket	= market,
		@recepushid	= pushid
	from dbo.tFVUserMaster where gameid = @receid_
	...
	if(isnull(@gameid, '') = '')
		...
		begin
			...
			if(@recemarket = @IPHONE)
				begin
					insert into dbo.tFVUserPushiPhone(sendid, receid, recepushid, sendkind, msgpush_id, msgtitle, msgmsg, msgaction)
				...
				begin
					insert into dbo.tFVUserPushAndroid(sendid, receid, recepushid, sendkind, msgpush_id, msgtitle, msgmsg, msgaction)
					values(@gameid, @receid, @recepushid, @kind_, 99, @msgtitle, @msgmsg, @msgaction)
