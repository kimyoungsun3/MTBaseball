...
select * from dbo.tFVUserMaster where gameid in('farm15193186', 'farm19483939')
select m.gameid, m.nickname, g.cnt, m.roulettepaycnt, m.vippoint, m.vippoint2, m.cashcost, m.cashcost2
from dbo.tFVUserMaster as m
 JOIN
...
select gameid, nickname, roulettepaycnt, vippoint, vippoint2, cashcost, cashcost2 from dbo.tFVUserMaster where roulettepaycnt > 100 order by 3 desc