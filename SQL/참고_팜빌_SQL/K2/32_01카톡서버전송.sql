...
-- update dbo.tFVCashLogKakaoSend set checkidx = 0	update dbo.tFVCashLog set kakaosend = -1, kakaouserid = '88258263875124913' where gameid = 'xxxx@gmail.com' and kakaosend = 1
