...
/*
-- 게임배치
SELECT * FROM dbo.fnu_FVSplitOneBig(',', '1,2,3,4,5,6,12,13,14')
...
select idx, listidx FROM dbo.fnu_FVSplitOneBig(',', '1,2,3,4,5,6,12,13,14')
...
IF OBJECT_ID ( N'dbo.fnu_FVSplitOneBig', N'TF' ) IS NOT NULL
	DROP FUNCTION dbo.fnu_FVSplitOneBig;
GO

CREATE FUNCTION dbo.fnu_FVSplitOneBig(
