...
public class NetworkHandler : MonoBehaviour
{
	...
	public delegate void parseCode(string data);
	...
	public void Request( WWWForm form, int action ) {
		Request( form, action, null ); 
	}	
	
	public void Request( int action, parseCode callback ) {
		WWWForm form = new WWWForm();
		Request( form, action, callback ); 
	}
	
	public void Request2(int _action, parseCode _cb){
	...
	//==========================================================================	
	public void Request( WWWForm form, int action, parseCode callback )
	{
		// Adds fields to form.
	...
	public void Request2(WWWForm _form, int _action, parseCode _cb){
	...
	//==========================================================================	
	public IEnumerator Handle( WWW _www, parseCode callback )
	{	
		...
		if( _www.error == null ){
			...
			// Is there a parseCode with this Request?
	    	if( callback != null ){ 
				Debug.Log(_www.data);
	        	callback( _www.data ); // Executes parseCode, passes in retrieved data
	        	callback = null; 
	      	} 
		}else{
	...
	// void TestConnection()
	//--------------------------------------------------------------------------
	// parseCode Method. Compares the retrieved data to a predetermined string.
	...
	// void Print()
	//--------------------------------------------------------------------------
	// parseCode Method. Used for Debugging purposes. This method is used as a 
