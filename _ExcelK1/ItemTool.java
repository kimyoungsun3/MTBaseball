...
public class ItemTool{
	...
	public static void main(String[] args) {
		...
		tool.itemTobyte3("roulette.csv", 2, true, 15);		//new model, shuffle
	}
	...
	public void itemTobyte(String _str, int _kind, boolean _bXML, boolean _bQuery){
		...
		String _element = "";
		String _query = "use Farm\nGO\n\n", _query2 = "", _queryHeader = "", _queryB1, _queryB2;
		String[] _queryParams = null;
		boolean _bOverDealBounusInfo = false;
		_query2 = "insert into dbo.tUserSaleRewardItemCode(itemcode)\nvalues(-1)\nGO\n\n";
	...
	public void itemTobyte2(String _str, int _kind, boolean _bQuery){
		...
		if(_kind == 1){
			//패키지.
			_query += "use Farm\nGO\n\n";
			_query += "delete from dbo.tItemInfo where subcategory = 500 and itemcode >= 50004\nGO\n\n";
