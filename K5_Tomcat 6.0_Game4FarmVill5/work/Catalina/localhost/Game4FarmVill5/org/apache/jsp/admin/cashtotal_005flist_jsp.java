...
public final class cashtotal_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	try{
      ...
      out.write("\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"cashtotal_list.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=4>\r\n");
      out.write("\t\t\t\t\t\t\t일별 캐쉬 구매(일자별 구매내역별 정렬)<br>\r\n");
      out.write("\t\t\t\t\t\t\t(* iPhone 구매는 달러이면 계산 편의상 원으로 환산된것입니다.)\r\n");
      out.write("\t\t\t\t\t\t\t<a href=cashtotal_list.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td> 구매날자[");
      ...
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>idx</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>dateid</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>market</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>판매단가</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<td>누적골든볼</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>누적캐쉬</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>횟수</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr><td colspan=7 align=right>");
      out.print(String.format("%,d", loopSum));
      out.write("</td></tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
...
if(loopPage++ == 1){
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=cashtotal_list.jsp?dateid=");
      out.print(result.getString("dateid"));
      out.write('>');
      out.print(result.getString("dateid"));
      out.write("</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("cashkind"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
...
if(dateid.equals("")){
      ...
      out.write("\t\t\t\t\t\t\t\t\t<a href=cashtotal_list.jsp?idxPage=");
