...
public final class wgiftsend_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"wgiftsend_list.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>검색 유저ID</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t<td>선물자<input name=\"giftid\" type=\"text\" value=\"");
      out.print(giftid);
      out.write("\" maxlength=\"16\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:154px;\"></td>\r\n");
      out.write("\t\t\t\t\t\t<td rowspan=\"2\" style=\"padding-left:5px;\"><input name=\"image\" type=\"image\" src=\"images/btn_send.gif\" border=\"0\" tabindex=\"3\"></td>\r\n");
      out.write("\t\t\t\t\t\t<td rowspan=\"2\" style=\"padding-left:5px;\"><a href=\"wgiftsend_form.jsp?gameid=");
      out.print(gameid);
      out.write("\">선물하기</a></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=5>\r\n");
      out.write("\t\t\t\t\t\t\t<a href=wgiftsend_list.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t 캐쉬선물, 쿠폰선물, 교배지급, 퀘스트지급, 랭킹보상, 로그인보상, 출석보상, 교배하트보상, 도감보상<br>\r\n");
      out.write("\t\t\t\t\t\t\t 튜토리얼보상, 농장수확물, 대회보상, 상인보상, 패키지구매, 초대 보상, 친구도움, 친구도움보상<br>\r\n");
      out.write("\t\t\t\t\t\t\t 액세서리뽑기, 오픈이벤트, 레벨업이벤트, 어린이날보상, 석가탄신보상<br>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</table>\r\n");
...
while(result.next()){
      ...
      out.write(' ');
      out.print(getCheckValueOri(result.getInt("idxt"), idx, "bgcolor=#ffe020", ""));
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("idxt"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><a href=wgiftsend_list.jsp?gameid=");
...
if(result.getInt("giftkind") == 2 || result.getInt("giftkind") == -2  || result.getInt("giftkind") == -3  || result.getInt("giftkind") == -4  ){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print(getCategoryUnit(result.getInt("category")));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>");
...
if(result.getInt("gainstate") == 0){
      ...
      out.write("&branch=wgiftsend_list&gameid=");
      out.print(result.getString("gameid"));
      out.write("&idx=");
      out.print(result.getInt("idxt"));
      out.write(">삭제마킹</a>\r\n");
