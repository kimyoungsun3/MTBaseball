...
public final class userroullogtotal_005fsub_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	try{
      ...
      out.write("\t\t\t\t\t\t\t세부 내역아이템구매날자[");
      out.print(dateid);
      out.write("]\r\n");
      out.write("\t\t\t\t\t\t\t<a href=userroullogtotal_mas.jsp>(돌아가기)</a>\r\n");
      out.write("\t\t\t\t\t\t\t<a href=userroullogtotal_sub.jsp?dateid=");
      out.print(dateid);
      out.write("&view=1>(이미지보기)</a>\r\n");
      out.write("\t\t\t\t\t\t\t<a href=userroullogtotal_sub.jsp?dateid=");
      out.print(dateid);
      out.write("&view=0>(노이미지)</a>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t");
					...
					//2. 데이타 조작
					//exec spu_FarmD 19, 412,-1, -1, -1, -1, -1, -1, -1, -1, '', '20131111', '', '', '', '', '', '', '', ''				-- 유저 뽑기월서브 통계
      ...
      out.write("\t\t\t\t\t\t\t<td>아이템</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>일반</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>루비뽑기</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>루비뽑기10+1</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
while(result.next()){
