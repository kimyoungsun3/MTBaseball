...
public final class giftgain_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("utf-8");
	...
	String giftkind		= util.getParamStr(request, "giftkind", "-1");
	...
	try{
		//2. 데이타 조작
		//exec spu_GiftGainNew 'xxxx6', '049000s1i0n7t8445289', -1, 75, -1	-- 쪽지
		query.append("{ call dbo.spu_GiftGainNew (?, ?, ?, ?, ?, ?, ?, ?)} ");
		cstmt = conn.prepareCall(query.toString());
		cstmt.setString(idxColumn++, gameid);
		cstmt.setString(idxColumn++, password);
		cstmt.setString(idxColumn++, giftkind);
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_GIFTGAIN); 						msg.append("</code>\n");
