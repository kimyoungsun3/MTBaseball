...
public final class anidie_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("utf-8");
	...
	String mode				= util.getParamStr(request, "mode", "");
	String listidx			= util.getParamStr(request, "listidx", "");
	/////////////////////////////////////////////////////////////////////
	//		파라미터 받기
	/////////////////////////////////////////////////////////////////////
	if(DEBUG_LOG_PARAM){
	...
	try{
		//2. 데이타 조작
		//exec spu_AniDie 'xxxx', '049000s1i0n7t8445289', 2, 5, -1		-- 늑대에 죽음.
		query.append("{ call dbo.spu_AniDie (?, ?, ?, ?, ?)} ");
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_ANIDIE); 			msg.append("</code>\n");
