...
public final class statistics_005fsub2_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t        \t\t<form name=\"GIFTFORM\" method=\"post\" action=\"statistics_sub2.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t");
					...
					//2. 데이타 조작
					//exec spu_FarmD 19, 98,  3, -1, -1, -1, -1, -1, -1, -1, '', '', '20140404', '', '', '', '', '', '', ''				--         레벨분포, 레벨통신사.
					...
					while(result.next()){
						...
						famelv 	= result.getInt("famelv");
						cnt 	= result.getInt("cnt");
						//out.print(dateid+":"+famelv+":"+cnt+"<br>");
