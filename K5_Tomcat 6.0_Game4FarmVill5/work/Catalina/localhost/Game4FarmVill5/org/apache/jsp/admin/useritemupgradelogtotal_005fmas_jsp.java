...
public final class useritemupgradelogtotal_005fmas_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	try{
      ...
      out.write("\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"useritemupgradelogtotal_sub.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=4>\r\n");
      out.write("\t\t\t\t\t\t\t아이템 업그레이드 내역(날짜를 누르면 세부 내역이 나옵니다.)\r\n");
      out.write("\t\t\t\t\t\t\t<a href=useritemupgradelogtotal_mas.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<!--\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td> 아이템구매날자[");
      out.print(dateid2);
      out.write("]</td>\r\n");
      out.write("\t\t\t\t\t\t<td> 검색</td>\r\n");
...
result = cstmt.executeQuery();
      ...
      out.write("\t\t\t\t\t\t\t<td>일</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>루비</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>코인(만)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>하트</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>강화횟수</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
while(result.next()){
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(String.format("%,d", (long)result.getLong("cashcost")));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(String.format("%,d", (long)result.getLong("gamecost")));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(String.format("%,d", (long)result.getLong("heart")));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("cnt"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><a href=useritemupgradelogtotal_sub.jsp?dateid=");
      out.print(result.getString("dateid8"));
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(String.format("%,d", (long)heart));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(sellcount);
      out.write("</td>\r\n");
