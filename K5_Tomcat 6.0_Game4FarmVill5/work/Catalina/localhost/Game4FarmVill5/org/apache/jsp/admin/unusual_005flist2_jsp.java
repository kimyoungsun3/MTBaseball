...
public final class unusual_005flist2_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"unusual_list2.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=4>\r\n");
      out.write("\t\t\t\t\t\t\t유저들이 뽑기, 거래 모니터 <a href=unusual_list2.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a><br>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>부정행위정보들</td>\r\n");
      out.write("\t\t\t\t\t\t<td>검색</td>\r\n");
...
while(result.next()){
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><a href=unusual_list2.jsp?gameid=");
      ...
      out.print(result.getString("gameid"));
      out.write(" target=_blank>정보검색</a> /\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=wgiftsend_form.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>선물/쪽지</a> /\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=wgiftsend_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>선물리스트</a> /\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=cashbuy_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>캐쉬검사</a> /\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=usersetting_ok.jsp?p1=19&p2=1007&p3=1&p4=");
      out.print(result.getString("idx"));
      out.write("&ps1=");
      out.print(result.getString("gameid"));
      out.write("&ps2=");
      out.print(adminid);
      out.write("&branch=unusual_list2&gameid=");
      out.print(result.getString("gameid"));
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t삭제\r\n");
      out.write("\t\t\t\t\t\t\t\t</a> /\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=usersetting_ok.jsp?p1=19&p2=1007&p3=2&p4=");
      out.print(result.getString("idx"));
      out.write("&ps1=");
      out.print(result.getString("gameid"));
      out.write("&ps2=");
      ...
      out.write("\t\t\t\t\t\t\t\t<a href=unusual_list2.jsp?idxPage=");
