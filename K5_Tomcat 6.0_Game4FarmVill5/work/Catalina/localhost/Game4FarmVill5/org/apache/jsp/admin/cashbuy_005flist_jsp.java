...
public final class cashbuy_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try{
      ...
      out.write("\t\t\t\t\t\t\t루비(캐쉬)구매 내역(유저기준 검색) > 검색을 하면 전체 내역이 나옵니다.<br>\r\n");
      out.write("\t\t\t\t\t\t\t(*오류발생(-444):게스트 유저는 카톡 아이디가 없어서 카톡 서버에 전송만 불가한 것입니다. 과금은 정상 처리된것입니다.)<br>\r\n");
      out.write("\t\t\t\t\t\t\t(* iPhone 구매는 달러이면 계산 편의상 원으로 환산된것입니다.)\r\n");
      out.write("\t\t\t\t\t\t\t<a href=cashbuy_list.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a>\r\n");
      ...
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"cashbuy_list.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td> 루비(캐쉬)구매자 서버 계정</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input name=\"gameid\" type=\"text\" value=\"");
      out.print(gameid);
      out.write("\" maxlength=\"16\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:304px;\"></td>\r\n");
      ...
      out.write("\t\t\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"cashbuy_list.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td> 영수증번호(TX_xxx(SKT), 19xx.xx(Google), xxxx(iPhone))</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input name=\"acode\" type=\"text\" value=\"");
      out.print(acode);
      out.write("\" maxlength=\"128\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:304px;\"></td>\r\n");
      out.write("\t\t\t\t\t\t<td style=\"padding-left:5px;\">\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"image\" type=\"image\" src=\"images/btn_send.gif\" border=\"0\" tabindex=\"3\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
...
if(!gameid.equals("")){
      ...
      out.write("&ps2=");
      out.print(adminid);
      out.write("&branch=cashbuy_list&gameid=");
      out.print(gameid);
      out.write(">블럭(계정,핸드폰)</a>\r\n");
      out.write("\t\t\t\t\t\t\t");
}
      out.write("\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t");
					...
					//2. 데이타 조작
					//exec spu_FarmD 21, 11,-1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''						-- 루비(캐쉬)판매로그
					//exec spu_FarmD 21, 11, 1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''						--
					//exec spu_FarmD 21, 11,10, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''						--
					//exec spu_FarmD 21, 11,10, -1, -1, -1, -1, -1, -1, -1, 'xxxx', '', '', '', '', '', '', '', '', ''					--
      ...
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>번호</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>환경(ikind)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>구매자(gameid)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>선물받은사람(giftid)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>승인번호1(acode)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>승인번호2(ucode)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>승인번호3(kakaouk)</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<td>루비(cashcost)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>현금(cash)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>구매일</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>market</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>카톡서버전송</td>\r\n");
      out.write("\t\t\t\t\t\t\t<!--\r\n");
      out.write("\t\t\t\t\t\t\t<td>전송원문(소스보기)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>전송해석(소스보기)</td>\r\n");
      out.write("\t\t\t\t\t\t\t-->\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t");
while(result.next()){
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=cashbuy_list.jsp?acode=");
      ...
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(String.format("%,d", result.getInt("cash")));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t(");
      out.print(result.getString("productid"));
      out.write(")\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
...
if(bAdmin && !bExpire){
      ...
      out.write(">블럭(계정,핸드폰)</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t/\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=usersetting_ok.jsp?p1=17&p2=1&p3=");
      out.print(result.getString("idx"));
      out.write("&ps1=");
      out.print(result.getString("gameid"));
      out.write("&branch=cashbuy_list&gameid=");
      ...
      out.write(">로그삭제</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t/\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=usersetting_ok.jsp?p1=17&p2=2&ps1=");
      out.print(result.getString("gameid"));
      out.write("&branch=cashbuy_list&gameid=");
      out.print(result.getString("gameid"));
      out.write(">로그일괄삭제</a>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(getKakaoSend(result.getInt("kakaosend")));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<!--\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("idata"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("idata2"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t-->\r\n");
      out.write("\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=13>총루비:");
      out.print(cashcosttotal);
      out.write(",  총캐쉬:");
      out.print(String.format("%,d", cashtotal));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t");
if(gameid.equals("")){
      ...
      out.write("\t\t\t\t\t\t\t\t\t<a href=cashbuy_list.jsp?idxPage=");
