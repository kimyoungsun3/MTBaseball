...
public final class systemboard_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"p2\" value=\"11\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"p3\" value=\"2\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"branch\" value=\"systemboard_list\">\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<a href=systemboard_list.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a><br>\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"p4\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"");
      out.print(boardkind[0]);
      out.write('"');
      out.write(' ');
      out.write('>');
      out.print(boardkind[1]);
      out.write("</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"ps10\" type=\"text\" value=\"내용을 작성하세요.\" size=\"60\" maxlength=\"256\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
...
for(int i = 0; i < boardkind.length; i+=2){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=usersetting_ok.jsp?p1=20&p2=11&p3=3&p5=");
      out.print(result.getString("idx"));
      out.write("&branch=systemboard_list>삭제</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=wgiftsend_form.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>쪽지</a>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t<a href=systemboard_list.jsp?idxPage=");
