...
public final class apartitemcode_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("utf-8");
	...
	try{
		...
		query.append("{ call dbo.spu_ApartItemcode (?, ?, ?, ?, ?, ?)} ");
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_APARTITEMCODE); 					msg.append("</code>\n");
		...
		msg.append("		<apartcnt>");		msg.append(result.getString("apartcnt"));  		msg.append("</apartcnt>\n");
		msg.append("	</result>\n");
