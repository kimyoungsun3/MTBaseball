...
public final class userrk_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t\t\t\t\t1. 룰렛을 돌려야지만이 랭킹이 기록됩니다.(\r\n");
      out.write("\t\t\t\t\t\t\t<font color=red>일</font>, 월, <font color=red>화</font>, 수, 목, <font color=red>금</font>, <font color=blue>토</font>) -> 기록<br>\r\n");
      out.write("\t\t\t\t\t\t\t랭킹전 결과 <a href=userrk_list.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\t\t\t");
					...
					//2. 데이타 조작
					//exec spu_FarmD 19, 3002,  1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''						-- 랭킹대전결과.
      ...
      out.write("\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>판매수익</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>생산배럴</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>배틀 포인트</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>교배,보물포인트</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>친구포인트</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>룰렛포인트</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>늑대포인트</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t");
while(result.next()){
      ...
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("rkdateid8"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(getRTReward(result.getInt("rkreward")));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(getCheckRKTeam(result.getInt("rkteam1"), result.getInt("rkteam0")));
      out.write("</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(getCheckRKTeam2(result.getLong("rksalemoney"), result.getLong("rksalemoney2")));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(getCheckRKTeam2(result.getLong("rksalebarrel"), result.getLong("rksalebarrel2")));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(getCheckRKTeam2(result.getLong("rkbattlecnt"), result.getLong("rkbattlecnt2")));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(getCheckRKTeam2(result.getLong("rkbogicnt"), result.getLong("rkbogicnt2")));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(getCheckRKTeam2(result.getLong("rkfriendpoint"), result.getLong("rkfriendpoint2")));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(getCheckRKTeam2(result.getLong("rkroulettecnt"), result.getLong("rkroulettecnt2")));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(getCheckRKTeam2(result.getLong("rkwolfcnt"), result.getLong("rkwolfcnt2")));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
}
