...
public final class zcporder_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"zcporder_list.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=2>\r\n");
      out.write("\t\t\t\t\t\t\t<a href=zcporder_list.jsp?stateCode=0>주문 대기중(흰색)</a>&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t<a href=zcporder_list.jsp?stateCode=1>주문 확인중(노랑)</a>&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t<a href=zcporder_list.jsp?stateCode=2>주문 발송완료(회색)</a>&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t<a href=zcporder_list.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"36%\">주문내용</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>처리내용<br>처리일<br>처리자</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t짜요장터구매처리.<br>\r\n");
...
while(result.next()){
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=zcporder_list.jsp?gameid=");
      ...
      out.write("<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(getDate(result.getString("orderdate")));
      out.write("<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=zcpmanager_list.jsp?idx=");
      out.print(result.getString("zcpidx"));
      ...
      out.write("<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(getDate(result.getString("deliverdate")));
      out.write("<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t        \t\t\t<input type=\"hidden\" name=\"p2\" value=\"41\">\r\n");
      ...
      out.print(adminid);
      out.write("\">\r\n");
      out.write("\t\t        \t\t\t<input type=\"hidden\" name=\"branch\" value=\"zcporder_list\">\r\n");
      ...
      out.print(result.getString("gameid"));
      out.write(" target=_blank>비정상검색2(일반)</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=userdellog_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>쿠폰사용내용</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t<a href=zcporder_list.jsp?idxPage=");
