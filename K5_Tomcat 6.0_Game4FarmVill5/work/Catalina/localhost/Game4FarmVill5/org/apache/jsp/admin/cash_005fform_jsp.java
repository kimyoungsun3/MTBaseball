...
public final class cash_005fform_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	int cnt 				= 0;
      ...
      out.write("        \t\t<form name=\"GIFTFORM\" method=\"post\" action=\"cash_ok.jsp\" onsubmit=\"return checkForm2(this);\">\r\n");
      out.write("\t    \t\t\t<input type=\"hidden\" name=\"p1\" value=\"21\">\r\n");
      ...
      out.write("        \t\t\t\t<font color=red>캐쉬 강제입력(로그기록이 남습니다.)</font><br>\r\n");
      out.write("        \t\t\t\tSKT \t: TX_00000000xxxxxx<br>\r\n");
      out.write("        \t\t\t\tGoogle \t: GPA.1343-7937-1808-39649<br>\r\n");
      out.write("        \t\t\t\tiPhone  : 57000005298xxxx<br>\r\n");
      out.write("        \t\t\t\t");
if(rtn == 1){out.println("정상입력");}
      out.write("\r\n");
      out.write("        \t\t\t\t<font color=red>이벤트 중이면 자동으로 해당 액수가 Plus되어서 지급됩니다. 해당하는 양만큼만 지급하면 됩니다.</font>\r\n");
      out.write("\r\n");
      out.write("        \t\t\t</td>\r\n");
      out.write("        \t\t</tr>\r\n");
      out.write("        \t\t<tr>\r\n");
      out.write("        \t\t\t<td>서버ID</td>\r\n");
      out.write("        \t\t\t<td><input name=\"ps1\" type=\"text\" value=\"");
      out.print(gameid);
      out.write("\" maxlength=\"128\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:400px;\"></td>\r\n");
      out.write("        \t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>금액</td>\r\n");
      out.write("        \t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t<select name=\"p3\">\r\n");
      out.write("\t\t\t\t\t\t\t");
for(int i = 0; i < strCash.length; i+=2){
      ...
      out.write("\t\t\t\t</tr>\r\n");
      out.write("        \t\t<tr>\r\n");
      out.write("        \t\t\t<td>영수증번호</td>\r\n");
      out.write("        \t\t\t<td><input name=\"ps3\" type=\"text\" value=\"\" maxlength=\"128\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:400px;\"></td>\r\n");
      out.write("        \t\t</tr>\r\n");
      out.write("        \t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td colspan=2 style=\"padding-left:5px;\"><input name=\"image\" type=\"image\" src=\"images/btn_send.gif\" border=\"0\" tabindex=\"3\"></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t        \t</form>\r\n");
      out.write("        \t</table>\r\n");
      out.write("\t\t</td>\r\n");
