...
public final class certno_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"certno_list.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t\t\t\t<input type=\"hidden\" name=\"mode\" value=\"2\">\r\n");
      ...
      out.print(gameid);
      out.write(" 지급확인중</font><br>\r\n");
      out.write("\t\t\t\t\t\t\t쿠폰 번호를 입력하시면 (미사용) / (사용된) 것이지 구분을 해줍니다.<br>\r\n");
      out.write("\t        \t\t\t\t단, 1개로 여러명이 하는 것음 검사가 안됩니다.(설문지 쿠폰은 검색이 안됩니다.)\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>쿠포검색</td>\r\n");
      out.write("\t\t\t\t\t\t<td>검색</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input name=\"certno\" type=\"text\" value=\"");
      out.print(certno);
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<tr><td colspan=5>공용쿠폰</td></tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>번호</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>쿠폰번호(<font color=blue>미사용</font>)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>내용</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>분류</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>기간</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
...
while(result.next()){
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>");
      out.print(result.getString("certno"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      ...
      out.write('(');
      out.write(' ');
      out.print(result.getString("cnt1"));
      out.write(" ) /\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      ...
      out.write('(');
      out.write(' ');
      out.print(result.getString("cnt3"));
      out.write(" )\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print( getCertMainKind( result.getInt("mainkind") ) );
      out.write(' ');
      out.write('(');
      out.write(' ');
      out.print(result.getInt("kind"));
      out.write(" )\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print( getDate16( result.getString("startdate") ) );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t~\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print( getDate16( result.getString("enddate") ) );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t");
...
if(cstmt.getMoreResults()){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr><td colspan=5><br><br>1인 1매쿠폰</td></tr>\r\n");
      out.write("\t\t\t\t\t<!-- 1인용 -->\r\n");
      out.write("\t\t\t\t\t");
while(result.next()){
      out.write("\r\n");
...
if(cstmt.getMoreResults()){
					result = cstmt.getResultSet();
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr><td colspan=5><br><br>사용쿠폰 </td></tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>번호</td>\r\n");
      out.write("\t\t\t\t\t\t<td>쿠폰번호(<font color=red>사용된것</font>)</td>\r\n");
      out.write("\t\t\t\t\t\t<td>내용</td>\r\n");
      out.write("\t\t\t\t\t\t<td>분류</td>\r\n");
      out.write("\t\t\t\t\t\t<td>사용날짜</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
while(result.next()){
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print( getDate16( result.getString("usedtime") ) );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
