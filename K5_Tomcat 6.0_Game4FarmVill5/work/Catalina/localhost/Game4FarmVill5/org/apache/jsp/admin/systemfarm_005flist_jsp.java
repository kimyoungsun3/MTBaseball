...
public final class systemfarm_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\tvar ps3 = '2:' + f.pack16.value + ';'\r\n");
      out.write("\t\t    + '3:' + f.pack17.value + ';'\r\n");
      out.write("\t\t    + '4:' + f.pack18.value + ';'\r\n");
      out.write("\t\t    + '5:' + f.pack19.value + ';'\r\n");
      out.write("\t\t    + '6:' + f.pack20.value + ';'\r\n");
      ...
      out.write("\t\t\t\t\t\t<td>유저동물제한</td>\r\n");
      out.write("\t\t\t\t\t\t<td>상대동물</td>\r\n");
      out.write("\t\t\t\t\t\t<td>enemylv</td>\r\n");
      out.write("\t\t\t\t\t\t<td>enemycnt</td>\r\n");
      out.write("\t\t\t\t\t\t<td>stagecnt</td>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t<td>enemyboss</td>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t");
while(result.next()){
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr ");
      out.print(getCheckValueOri(result.getInt("itemcode"), itemcode, "bgcolor=#ffe020", ""));
      out.write(' ');
      out.print(result.getInt("itemcode") >= 6930?"bgcolor=#aaffaa":"");
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"usersetting_ok.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"branch\" value=\"systemfarm_list\">\r\n");
      out.write("\t\t\t\t\t\t<input name=itemcode type=hidden value=");
      out.print(result.getString("itemcode"));
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"p1\" value=\"30\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"p2\" value=\"61\">\r\n");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(result.getString("param14"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t");
      ...
      out.print(limitaniInt[k2]);
      out.write('"');
      out.write(' ');
      out.print(getSelect(param, limitaniInt[k2]));
      out.write('>');
      out.print(limitaniStr[k2]);
      out.write("</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
}
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input name=\"pack17\" type=\"text\" value=\"");
      out.print(result.getInt("param17"));
      out.write("\" size=\"2\" maxlength=\"2\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"></td>\r\n");
      out.write("\t\t\t\t\t\t<td><input name=\"pack18\" type=\"text\" value=\"");
      out.print(result.getInt("param18"));
      out.write("\" size=\"2\" maxlength=\"2\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"></td>\r\n");
      out.write("\t\t\t\t\t\t<td><input name=\"pack19\" type=\"text\" value=\"");
      out.print(result.getInt("param19"));
      out.write("\" size=\"2\" maxlength=\"2\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"></td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"");
      out.print(enemybossInt[k2]);
      out.write('"');
      out.write(' ');
      out.print(getSelect(param, enemybossInt[k2]));
      out.write('>');
      out.print(enemybossStr[k2]);
      out.write("</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
}
      out.write("\r\n");
