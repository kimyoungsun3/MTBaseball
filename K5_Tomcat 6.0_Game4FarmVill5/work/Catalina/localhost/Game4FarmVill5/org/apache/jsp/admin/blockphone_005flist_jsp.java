...
public final class blockphone_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	try{
      ...
      out.write("\t\t\t<input type=\"hidden\" name=\"p2\" value=\"22\">\r\n");
      out.write("\t\t\t<input name=branch type=hidden value=blockphone_list>\r\n");
      out.write("\t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t[블럭처리폰]<br>\r\n");
      out.write("\t\t\t\t\t\t\t블럭을 처리되면 가입할때 무조건 블럭으로 처리된다.<br>\r\n");
      out.write("\t\t\t\t\t\t\t해킹이나 데이타 조작을 한 유저들.\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
...
while(result.next()){
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><a href=usersetting_ok.jsp?p1=19&p2=23&ps3=");
      out.print(result.getString("phone"));
