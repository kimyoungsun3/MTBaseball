...
public final class cashtotal_005flist2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	try{
      ...
      out.write("\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"cashtotal_list2.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=3>\r\n");
      out.write("\t\t\t\t\t\t\t월별 캐쉬 구매(일자별 구매내역별 정렬)<br>\r\n");
      out.write("\t\t\t\t\t\t\t(* iPhone 구매는 달러이면 계산 편의상 원으로 환산된것입니다.)\r\n");
      out.write("\t\t\t\t\t\t\t<a href=cashtotal_list2.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td> 검색</td>\r\n");
      ...
      out.print(dateid);
      out.write("\" maxlength=\"6\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:154px;\"></td>\r\n");
      ...
      out.write("\t\t\t\t\t");
					...
					//2. 데이타 조작
					//exec spu_FarmD 21, 13,-1, -1, -1, -1, -1, -1, -1, -1, '', '201404', '', '', '', '', '', '', '', ''				--
...
for(int i = 0; i < len; i++){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=100p>");
      out.print(listDate[i]);
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=100p>");
      out.print(String.format("%,d", listSKT[i]));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=100p>");
      out.print(String.format("%,d", listGOOGLE[i]));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=100p>");
      out.print(String.format("%,d", listIPHONE[i]));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=100p>");
      out.print(String.format("%,d", listNHN[i]));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=100p>");
      out.print(String.format("%,d", listDateTotal[i]));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
}
