...
public final class anicompose_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("utf-8");
	...
	String itemcode 	= util.getParamStr(request, "itemcode", "101002");
	String listidxbase 	= util.getParamStr(request, "listidxbase", "-1");
	...
	try{
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_ANICOMPOSE); 					msg.append("</code>\n");
		...
		msg.append("		<bgcomposeic>");	msg.append(result.getInt("bgcomposeic"));    	msg.append("</bgcomposeic>\n");
		msg.append("		<bgcomposert>");	msg.append(result.getInt("bgcomposert"));    	msg.append("</bgcomposert>\n");
