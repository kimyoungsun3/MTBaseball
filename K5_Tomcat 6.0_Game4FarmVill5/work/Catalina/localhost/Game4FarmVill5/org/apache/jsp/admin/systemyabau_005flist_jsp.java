...
public final class systemyabau_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
		//2. 데이타 조작
		//exec spu_FarmD 30, 46, -1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''
      ...
      out.write("\tvar ps3 = '1:' + f.pack11.value + ':' + f.pack12.value + ':' + f.pack13.value + ':' + f.pack14.value + ';'\r\n");
      out.write("\t\t    + '2:' + f.pack21.value + ':' + f.pack22.value + ':' + f.pack23.value + ':' + f.pack24.value + ';'\r\n");
      out.write("\t\t    + '3:' + f.pack31.value + ':' + f.pack32.value + ':' + f.pack33.value + ':' + f.pack34.value + ';'\r\n");
      out.write("\t\t    + '4:' + f.pack41.value + ':' + f.pack42.value + ':' + f.pack43.value + ':' + f.pack44.value + ';'\r\n");
      out.write("\t\t    + '5:' + f.pack51.value + ':' + f.pack52.value + ':' + f.pack53.value + ':' + f.pack54.value + ';'\r\n");
      out.write("\t\t    + '6:' + f.pack61.value + ':' + f.pack62.value + ':' + f.pack63.value + ':' + f.pack64.value + ';'\r\n");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>idx</td>\r\n");
      out.write("\t\t\t\t\t\t<td>행운의 명치</td>\r\n");
      out.write("\t\t\t\t\t\t<td>허용레벨</td>\r\n");
      out.write("\t\t\t\t\t\t<td>상품(상품코드/주사위/루비/코인/상품내용)</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<a href=systemyabau_list.jsp?packstate=");
...
if(cnt > 0){
      ...
      out.print(result.getString("saleper"));
      ...
      out.write("\" size=\"20\" maxlength=\"20\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
...
for(int k2 = 1; k2 <= 12; k2++){
 ...
 pack2 = result.getInt("pack" + kk+"2");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"pack");
      out.print(kk);
      out.write("3\" type=\"text\" value=\"");
      out.print(result.getInt("pack" + kk+"3"));
      out.write("\" size=\"5\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"pack");
      out.print(kk);
      out.write("4\" type=\"text\" value=\"");
      out.print(result.getInt("pack" + kk+"4"));
      out.write("\" size=\"7\" maxlength=\"7\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
