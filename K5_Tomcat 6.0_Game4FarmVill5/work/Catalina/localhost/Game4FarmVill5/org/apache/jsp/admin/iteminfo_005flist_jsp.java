...
public final class iteminfo_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t<a href=iteminfo_list.jsp?view=1>이미지보기</a>\r\n");
      out.write("\t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"iteminfo_list.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t        \t\t\t\t<input type=\"hidden\" name=\"view\" value=\"");
      out.print(view);
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t<td>itemcode검색</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input name=\"itemcode\" type=\"text\" value=\"");
      out.print(itemcode==-1?"":(itemcode+""));
      ...
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t<form name=\"GIFTFORM\" method=\"post2\" action=\"iteminfo_list.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" name=\"view\" value=\"");
      out.print(view);
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t<td>category</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input name=\"category\" type=\"text\" value=\"");
      out.print(category==-1?"":(category+""));
      out.write("\" maxlength=\"16\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:154px;\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td rowspan=\"2\" style=\"padding-left:5px;\"><input name=\"image\" type=\"image\" src=\"images/btn_send.gif\" border=\"0\" tabindex=\"3\"></td>\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t<form name=\"GIFTFORM\" method=\"post2\" action=\"iteminfo_list.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<td><input name=\"subcategory\" type=\"text\" value=\"");
      out.print(subcategory==-1?"":(subcategory+""));
      out.write("\" maxlength=\"16\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:154px;\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td rowspan=\"2\" style=\"padding-left:5px;\"><input name=\"image\" type=\"image\" src=\"images/btn_send.gif\" border=\"0\" tabindex=\"3\">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=iteminfo_list.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a></td>\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\r\n");
...
if(view == 1){
      ...
      out.write("\t\t\t\t\t\t\t<td>category</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>subcategory</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>equpslot</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>activate</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>toplist</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>grade</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>discount</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>icon</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>playerlv</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>houselv</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>gamecost</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>cashcost</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>buyamount</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>sellcost</td>\r\n");
...
while(result.next()){
      ...
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("labelname"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(getDanilga(result.getInt("subcategory"), result.getInt("gamecost"), result.getInt("cashcost"), result.getInt("buyamount"), result.getInt("sellcost")));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><a href=iteminfo_list.jsp?itemcode=");
      out.print(result.getString("itemcode"));
      out.write("&view=");
      out.print(view);
      out.write('>');
...
if(view == 1){
 ...
 if( _category == 1010 ){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
      out.print(checkImgParam(view, result.getInt("subcategory"), 12, result.getString("param12"), imgroot));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
}else{
      out.write("\r\n");
      ...
      out.print(imgroot);
      out.write('/');
      out.print(result.getInt("itemcode"));
      out.write(".png> ");
      out.print(result.getInt("itemcode"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=iteminfo_list.jsp?category=");
      ...
      out.write("</a>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><a href=iteminfo_list.jsp?subcategory=");
      out.print(result.getString("subcategory"));
      out.write("&view=");
      out.print(view);
      out.write('>');
      out.print(result.getString("subcategory"));
      out.write("</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("equpslot"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("activate"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("toplist"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("grade"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("discount"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("icon"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("playerlv"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("houselv"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("buyamount"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("sellcost"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("description"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 1, result.getString("param1"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(
      ...
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 3, result.getString("param3"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 4, result.getString("param4"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 5, result.getString("param5"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 6, result.getString("param6"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 7, result.getString("param7"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 8, result.getString("param8"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 9, result.getString("param9"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 10, result.getString("param10"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 11, result.getString("param11"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 12, result.getString("param12"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 13, result.getString("param13"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 14, result.getString("param14"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 15, result.getString("param15"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 16, result.getString("param16"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 17, result.getString("param17"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 18, result.getString("param18"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 19, result.getString("param19"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 20, result.getString("param20"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 21, result.getString("param21"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 22, result.getString("param22"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 23, result.getString("param23"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 24, result.getString("param24"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 25, result.getString("param25"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 26, result.getString("param26"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 27, result.getString("param27"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 28, result.getString("param28"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 29, result.getString("param29"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 30, result.getString("param30"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
}
