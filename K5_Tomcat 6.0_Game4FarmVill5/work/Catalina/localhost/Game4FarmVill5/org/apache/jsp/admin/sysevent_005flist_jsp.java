...
public final class sysevent_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t\t\t\t\t- 내용은 하단에 textarea 사이즈 조절이 됩니다.<br>\r\n");
      out.write("\t\t\t\t\t\t\t- 소속이외에 것을 수정할때는 조심하는 것이 좋습니다.<br>\r\n");
      out.write("\t\t\t\t\t\t\t<a href=sysevent_list.jsp?stateCode=0&mode=");
      out.print(mode);
      out.write(">대기중(흰색)</a>,\r\n");
      out.write("\t\t\t\t\t\t\t<a href=sysevent_list.jsp?stateCode=1&mode=");
      out.print(mode);
      out.write(">진행중(노랑)</a>,\r\n");
      out.write("\t\t\t\t\t\t\t<a href=sysevent_list.jsp?stateCode=2&mode=");
      out.print(mode);
      out.write(">완료(회색)</a>,\r\n");
      out.write("\t\t\t\t\t\t\t<a href=sysevent_list.jsp?mode=0>읽기모드</a>,\r\n");
      out.write("\t\t\t\t\t\t\t<a href=sysevent_list.jsp?mode=1>수정모드</a>,\r\n");
      out.write("\t\t\t\t\t\t\t<a href=sysevent_list.jsp?mode=");
      out.print(mode);
      out.write("><img src=images/refresh2.png alt=\"화면갱신\"></a>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t        \t\t\t<input type=\"hidden\" name=\"p2\" value=\"31\">\r\n");
      out.write("\t        \t\t\t<input type=\"hidden\" name=\"p3\" value=\"1\">\r\n");
      out.write("\t        \t\t\t<input type=\"hidden\" name=\"ps2\" value=\"");
      out.print(adminid);
      out.write("\">\r\n");
      out.write("\t        \t\t\t<input type=\"hidden\" name=\"branch\" value=\"sysevent_list\">\r\n");
      out.write("\t\t\t\t\t\t<td>새로작성</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t");
      out.print(adminid);
      out.write("<br>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<option value=\"0\">대기중(0)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"1\">진행중(1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"2\">완료(2)</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t        \t\t\t<input name=\"ps3\" type=\"text\" value=\"");
      out.print(dateid);
      out.write("\" maxlength=\"16\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:150px;\"><br>\r\n");
      out.write("\t\t        \t\t\t~<br>\r\n");
      out.write("\t\t        \t\t\t<input name=\"ps4\" type=\"text\" value=\"");
      out.print(dateid);
      out.write("\" maxlength=\"16\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:150px;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"p6\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"0\">상상디지탈(0)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"1\">픽토소프트(1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t        \t\t\t<input name=\"ps9\" type=\"text\" value=\"\" maxlength=\"600\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:600px;\"><br>\r\n");
      out.write("\t\t        \t\t\t<textarea name=\"ps10\" rows=\"10\" cols=\"130\" style=\"border:solid 1px black; font-family:tahoma; background-color:lightsteelblue;\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
...
while(result.next()){
      ...
      out.write("\t\t\t\t\t\t\t\t\t<select name=\"p6\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"0\" ");
      out.print(getSelect(result.getInt("company"), 0));
      out.write(">상상디지탈(0)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"1\" ");
      out.print(getSelect(result.getInt("company"), 1));
      out.write(">픽토소프트(1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t        \t\t\t");
...
while(result.next()){
      ...
      out.print(result.getString("title"));
      out.write("\" maxlength=\"600\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:600px;\"><br>\r\n");
      out.write("\t\t\t\t        \t\t\t<textarea name=\"ps10\" rows=\"10\" cols=\"130\" style=\"border:solid 1px black; font-family:tahoma; background-color:lightsteelblue;\">");
      out.print(result.getString("comment"));
      out.write("</textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<a href=sysevent_list.jsp?idxPage=");
