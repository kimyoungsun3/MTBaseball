...
public final class sysinquire_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("}\r\n");
      out.write("function f_Submit2(f) {\r\n");
      out.write("\tif(f.ps3 == '') return false;\r\n");
      out.write("\telse return true;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("//-->\r\n");
      ...
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"sysinquire_list.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=2>\r\n");
      out.write("\t\t\t\t\t\t\t<a href=sysinquire_list.jsp?stateCode=0>문의중(흰색)</a>,\r\n");
      out.write("\t\t\t\t\t\t\t<a href=sysinquire_list.jsp?stateCode=1>확인중(노랑)</a>,\r\n");
      out.write("\t\t\t\t\t\t\t<a href=sysinquire_list.jsp?stateCode=2>처리완료(회색)</a>,\r\n");
      out.write("\t\t\t\t\t\t\t<a href=sysinquire_list.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t<a href=https://play.google.com/store/apps/details?id=com.marbles.farmvill5gg target=_blank>Google Site</a>\r\n");
      out.write("\t\t\t\t\t\t\t<a href=sysinquire_info.txt target=_blank>문의 샘플</a>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"gameid\" type=\"text\" value=\"");
      out.print(gameid);
      out.write("\" size=\"20\" maxlength=\"256\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"image\" type=\"image\" src=\"images/btn_send.gif\" border=\"0\" tabindex=\"3\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t<table border=1 width=1300>\r\n");
      out.write("\t\t\t\t\t");

					//2. 데이타 조작
					//exec spu_FarmD 20, 21, 1,  1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''						-- 문의글 읽기.
      ...
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=\"36%\">문의내용</td>\r\n");
      out.write("\t\t\t\t\t\t\t<!--<td>관리자</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>상태</td>-->\r\n");
      out.write("\t\t\t\t\t\t\t<td>처리내용<br>처리일<br>처리자</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t문의처리<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t- 글을 쓰면 유저에게 쪽지로 발송됩니다.<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t- 빈공백이면 쪽지발송 안하면 상태만 변경됩니다.<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t- 쪽지글은 100자 이하를 권장합니다.<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t- 전체글은 500자까지만 기록됩니다.(첫글, 두번째글...)\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td width=8%>선물지급, 푸쉬발송, 유저검색</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t");
while(result.next()){
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<tr ");
      out.print(getInQuireStateColor(result.getInt("state")));
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("idx"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=sysinquire_list.jsp?gameid=");
...
for(int i = 0; i < state.length; i+=2){
      ...
      out.write("<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(getDate(result.getString("dealdate")));
      out.write("<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
...
if(result.getInt("state") != 2){
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=usersetting_ok.jsp?p1=20&p2=21&p3=2&p4=&p5=");
      out.print(result.getString("idx"));
      out.write("&p6=1&p7=1&ps2=");
      out.print(adminid);
      out.write("&branch=sysinquire_list&idx=");
      out.print(idxPage);
      out.write(">확인중(쪽지발송)</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=usersetting_ok.jsp?p1=20&p2=21&p3=2&p4=&p5=");
      out.print(result.getString("idx"));
      out.write("&p6=2&p7=1&ps2=");
      out.print(adminid);
      out.write("&branch=sysinquire_list&idx=");
      out.print(idxPage);
      out.write(">완료(쪽지발송)</a>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t-->\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"usersetting_ok.jsp\" onsubmit=\"return f_Submit2(this);\">\r\n");
      out.write("\t\t        \t\t\t<input type=\"hidden\" name=\"p1\" value=\"20\">\r\n");
      out.write("\t\t        \t\t\t<input type=\"hidden\" name=\"p2\" value=\"21\">\r\n");
      out.write("\t\t        \t\t\t<input type=\"hidden\" name=\"p3\" value=\"2\">\r\n");
      out.write("\t\t        \t\t\t<input type=\"hidden\" name=\"p4\" value=\"\">\r\n");
      out.write("\t\t        \t\t\t<input type=\"hidden\" name=\"p5\" value=\"");
      out.print(result.getString("idx"));
      out.write("\">\r\n");
      out.write("\t\t        \t\t\t<input type=\"hidden\" name=\"p7\" value=\"1\">\r\n");
      out.write("\t\t        \t\t\t<input type=\"hidden\" name=\"ps2\" value=\"");
      out.print(adminid);
      out.write("\">\r\n");
      out.write("\t\t        \t\t\t<input type=\"hidden\" name=\"branch\" value=\"sysinquire_list\">\r\n");
      ...
      out.print(getSelect(result.getInt("state"), 0));
      out.write(">문의중(0)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"1\" ");
      out.print(getSelect(result.getInt("state"), 1));
      out.write(">확인중(1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"2\" ");
      out.print(getSelect(result.getInt("state"), 2));
      out.write(">처리완료(2)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t        \t\t\t<input name=\"ps3\" type=\"text\" value=\"\" maxlength=\"128\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:300px;\">\r\n");
      out.write("\t\t\t        \t\t\t<input name=\"image\" type=\"image\" src=\"images/btn_send.gif\" border=\"0\" tabindex=\"3\">\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<a href=wgiftsend_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>선물리스트</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=push_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write("&personal=1 target=_blank>푸쉬발송</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=userinfo_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>");
      out.print(result.getString("gameid"));
      out.write("</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=useritembuylog_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>구매로그</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=certno_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>쿠폰검사</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=certno_form.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>쿠폰강제입력</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=cashbuy_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>캐쉬검사</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=cash_form.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>캐쉬강제입력</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=unusual_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>비정상검색(일반)</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=unusual_list2.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>비정상검색(교배)</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=userdielog_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>동물죽음</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=useralivelog_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>동물부활</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=usercomplog_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>동물합성</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=userroullog_list3.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>행운의 주사위</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=usermarket_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>마켓이동</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=userdellog_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write(" target=_blank>판매/합성/분해로고</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t<a href=sysinquire_list.jsp?idxPage=");
