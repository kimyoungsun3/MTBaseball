...
public final class newstart_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("utf-8");
	...
	try{
		//2. 데이타 조작
		//exec spu_NewStart 'guest115913',  '4152786m4f7y6w381582', 'A_1Gfn5G_QM', -1
		query.append("{ call dbo.spu_NewStart (?, ?, ?, ?)} ");
		cstmt = conn.prepareCall(query.toString());

		cstmt.setString(idx++, gameid);
		cstmt.setString(idx++, password);
		cstmt.setString(idx++, kakaouserid);
		...
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_NEWSTART); 				msg.append("</code>\n");
