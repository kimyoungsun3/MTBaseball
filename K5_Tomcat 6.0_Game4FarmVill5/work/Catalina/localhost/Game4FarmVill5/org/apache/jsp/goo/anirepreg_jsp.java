...
public final class anirepreg_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("utf-8");
	...
	try{
		...
		//2. 데이타 조작
		//exec spu_AniRepReg 'xxxx', '049000s1i0n7t8445289', 17, -1
		query.append("{ call dbo.spu_AniRepReg (?, ?, ?, ?)} ");
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_ANIREPREG); 					msg.append("</code>\n");
