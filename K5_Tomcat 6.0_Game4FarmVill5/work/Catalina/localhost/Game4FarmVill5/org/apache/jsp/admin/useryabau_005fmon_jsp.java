...
public final class useryabau_005fmon_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	try{
      ...
      out.write("\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"useryabau_mon.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<a href=useryabau_mon.jsp?view=0&dateid=");
      out.print(dateid);
      out.write(">그냥보기</a>\r\n");
      out.write("\t\t\t\t\t\t\t<a href=useryabau_mon.jsp?view=1&dateid=");
      out.print(dateid);
      out.write(">이미지보기</a>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t");
					...
					//2. 데이타 조작
					//exec spu_FarmD 19, 417,-1, -1, -1, -1, -1, -1, -1, -1, '', '201407', '', '', '', '', '', '', '', ''				--        월통계
					query.append("{ call dbo.spu_FarmD (?, ?, ?, ?, ?,   ?, ?, ?, ?, ?,   ?, ?, ?, ?, ?,   ?, ?, ?, ?, ?)} ");
					cstmt = conn.prepareCall(query.toString());
					cstmt.setInt(idxColumn++, 19);
					cstmt.setInt(idxColumn++, 417);
