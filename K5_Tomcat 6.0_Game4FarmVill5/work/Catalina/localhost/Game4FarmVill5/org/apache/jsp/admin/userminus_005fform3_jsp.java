...
public final class userminus_005fform3_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String gameid 		= util.getParamStr(request, "gameid", "");
      ...
      out.write("\t\t\t\t\t\t\t\t");
      out.print(title);
      out.write("(정수만 입력해주세요)\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input name=\"p4\" type=\"text\" value=\"\" maxlength=\"9\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:400px;\"></td>\r\n");
