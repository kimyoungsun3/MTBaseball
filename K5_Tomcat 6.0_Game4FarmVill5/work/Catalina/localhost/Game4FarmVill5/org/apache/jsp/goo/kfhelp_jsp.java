...
public final class kfhelp_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("utf-8");
	...
	try{
		//2. 데이타 조작
		//exec spu_KakaoFriendHelp 'xxxx2', '049000s1i0n7t8445289', 'xxxx',  22, -1
		query.append("{ call dbo.spu_KakaoFriendHelp (?, ?, ?, ?, ?)} ");
		cstmt = conn.prepareCall(query.toString());

		cstmt.setString(idx++, gameid);
		cstmt.setString(idx++, password);
		cstmt.setString(idx++, friendid);
		...
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_KFHELP); 				msg.append("</code>\n");
