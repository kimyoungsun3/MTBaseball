...
public final class userrank_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t\t\t\t\t1. 현재 판매랭킹. <a href=userrank_list.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\t\t\t");
					...
					//2. 데이타 조작
					//exec spu_FarmD 21, 31,-1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''						-- 유저판매현재랭킹.
      ...
      out.write("\t\t\t\t\t\t\t<td>anirepitemcode</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>ttsalecoin</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>gameid</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>kakaonickname</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>실결제</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>보유캐쉬</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t");
while(result.next()){
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(displayMoney(result.getString("ttsalecoin")));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
