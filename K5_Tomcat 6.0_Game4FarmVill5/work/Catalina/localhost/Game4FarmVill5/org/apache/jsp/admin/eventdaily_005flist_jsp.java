...
public final class eventdaily_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"p2\" value=\"52\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"p3\" value=\"1\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"p4\" value=\"-1\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"branch\" value=\"eventdaily_list\">\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>선물아이템</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"p5\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t");
for(int i = 0; i < cnt; i++){
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"p7\" type=\"text\" value=\"0\" size=\"3\" maxlength=\"3\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>상태</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"p6\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"0\">비활성(0)</option>\r\n");
      ...
      out.write("\t\t\t\t\t\t<td>선물자</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"ps3\" type=\"text\" value=\"짜요 소녀\" size=\"20\" maxlength=\"20\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>날짜</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t2014-05-24 12:00 ~ 2014-05-24 17:59 (형식2) > 24일 12시 ~ 17(17:59)까지<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t2014-05-24 18:00 ~ 2014-05-24 23:59 (형식2) > 24일 18시 ~ 23(23:59)까지\r\n");
      out.write("\t\t\t\t\t\t\t</font><br>\r\n");
      out.write("\r\n");
...
for(int i = 0; i <= 23; i++){
      ...
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>푸쉬제목</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"ps9\" type=\"text\" value=\"푸쉬제목\" size=\"128\" maxlength=\"128\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>푸쉬내용</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"ps10\" type=\"text\" value=\"푸쉬내용\" size=\"128\" maxlength=\"128\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
...
if(cstmt.getMoreResults()){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>전체 진행상태</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<font color=blue>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<a href=usersetting_ok.jsp?p1=30&p2=51&branch=eventdaily_list>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(getEventStateMaster(result.getInt("eventstatemaster")));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</font>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
...
if(cstmt.getMoreResults()){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<tr ");
      out.print(getCheckValueOri(result.getInt("eventstatedaily"), 0, "bgcolor=#aaaaaa", ""));
      out.write(' ');
      out.print(getCheckValueOri(result.getInt("eventidx"), eventidx, "bgcolor=#ffe020", ""));
      out.write(' ');
      out.print(bgcolor);
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"usersetting_ok.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      ...
      out.print(result.getString("eventidx"));
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"p1\" value=\"30\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"p2\" value=\"52\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"p3\" value=\"2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"p4\" value=\"");
      out.print(result.getInt("eventidx"));
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"branch\" value=\"eventdaily_list\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      ...
      out.print(getSelect(result.getInt("eventstatedaily"), 0));
      out.write(">비활성(0)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"1\" ");
      out.print(getSelect(result.getInt("eventstatedaily"), 1));
      out.write(">  활성(1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"p5\" type=\"text\" value=\"");
      out.print(result.getInt("eventitemcode"));
      out.write("\" size=\"5\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"> x\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"p7\" type=\"text\" value=\"");
      out.print(result.getInt("eventcnt"));
      out.write("\" size=\"3\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">개<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      ...
      out.print(result.getString("eventsender"));
      out.write("\" size=\"20\" maxlength=\"20\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"ps4\" type=\"text\" value=\"");
      out.print(result.getString("eventday"));
      out.write("\" size=\"2\" maxlength=\"2\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">일\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"ps5\" type=\"text\" value=\"");
      out.print(result.getString("eventstarthour"));
      out.write("\" size=\"2\" maxlength=\"2\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">시\r\n");
      out.write("\t\t\t\t\t\t\t\t\t~\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"ps6\" type=\"text\" value=\"");
      out.print(result.getString("eventendhour"));
      out.write("\" size=\"2\" maxlength=\"2\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">:59\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"ps9\" type=\"text\" value=\"");
      out.print(result.getString("eventpushtitle"));
      out.write("\" size=\"60\" maxlength=\"128\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"ps10\" type=\"text\" value=\"");
      out.print(result.getString("eventpushmsg"));
      out.write("\" size=\"60\" maxlength=\"128\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=usersetting_ok.jsp?p1=30&p2=52&p3=3&p4=");
      out.print(result.getString("eventidx"));
      out.write("&branch=eventdaily_list>이벤트:");
      out.print(getEventState(result.getInt("eventstatedaily")));
      out.write("</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=usersetting_ok.jsp?p1=30&p2=52&p3=4&p4=");
      out.print(result.getString("eventidx"));
      out.write("&branch=eventdaily_list>푸쉬:");
      out.print(getEventPush(result.getInt("eventpushstate")));
      out.write("</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=push_list.jsp target=_blank>푸쉬발송</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=usersetting_ok.jsp?p1=30&p2=52&p3=5&p4=");
      out.print(result.getString("eventidx"));
      out.write("&branch=eventdaily_list>삭제(한명이 받으면 삭제불가)</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"image\" type=\"image\" src=\"images/btn_send.gif\" border=\"0\" tabindex=\"3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
