...
public final class aniupgrade_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("utf-8");
	...
	String listidxani		= util.getParamStr(request, "listidxani", "-1");
	...
	try{
		...
		query.append("{ call dbo.spu_AniUpgrade (?, ?, ?, ?, ?, ?)} ");
		cstmt = conn.prepareCall(query.toString());

		cstmt.setString(idxColumn++, gameid);
		cstmt.setString(idxColumn++, password);
		cstmt.setString(idxColumn++, listidxani);
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_ANIUPGRADE); 					msg.append("</code>\n");
