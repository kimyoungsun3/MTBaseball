...
public final class kfreset_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("utf-8");
	...
	try{
		...
		query.append("{ call dbo.spu_KakaoFriendReset (?, ?, ?, ?)} ");
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_KFRESET); 			msg.append("</code>\n");
