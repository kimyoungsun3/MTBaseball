...
public final class usercomreward_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"usercomreward.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=3>\r\n");
      out.write("\t\t\t\t\t\t\t유저들이 퀘스트 상태<a href=usercomreward.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a><br>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>검색</td>\r\n");
      ...
      out.write("\t\t\t\t\t");
					...
					//2. 데이타 조작
					//exec spu_FarmD 19, 1008, -1, -1, -1, -1, -1, -1, -1, -1, 'xxxx2', '', '', '', '', '', '', '', '', ''				-- 경쟁모드(퀘스트정보).
...
while(result.next()){
      ...
      out.write(")</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><a href=usercomreward.jsp?gameid=");
      ...
      out.write("\t\t\t\t\t\t\t\t<a href=usercomreward.jsp?idxPage=");
