...
public final class systeminfo_005flist2_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<a href=systeminfo_list2.jsp?view=1>입력보기</a><a href=systeminfo_list2.jsp?view=0>그냥보기</a>\r\n");
      out.write("\t\t\t\t");
if(view == 1){
      out.write("\r\n");
      out.write("\t\t\t\t<table>\r\n");
      ...
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"p2\" value=\"5\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"ps9\" value=\"\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"branch\" value=\"systeminfo_list2\">\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>마켓</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
...
for(int i = 0; i <= 10; i++){
      ...
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>동물활성화</td>\r\n");
      out.write("\t\t\t\t\t\t<td>동물 뽑으면 루비지급 활성화.\r\n");
      ...
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>동물/보상</t1d>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t반드시 1번이 보상이 높은 것을 선택하세요.<br>\r\n");
      out.write("\t\t\t\t\t\t\t1. 선택한 동물, 2. 그 동물이 나오면 보상되는 템 3. 그때 사람들이 받는 메세지(꼭 입력하세요)<br>\r\n");
      out.write("\t\t\t\t\t\t\t예)얼짱 산양(213) 2. 90루비(5017) 3.얼짱 산양보상<br>\r\n");
      out.write("\t\t\t\t\t\t\t예)얼짱 양(112) 2. 20루비(5010) 3.얼짱 양보상<br>\r\n");
      out.write("\t\t\t\t\t\t\t예)얼짱 젖소(14) 2. 10루비(5009) 3.얼짱 젖소보상<br>\r\n");
      out.write("\t\t\t\t\t\t\t동물1<select name=\"d2\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t");
for(int i = 0; i < cnt; i++){
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"");
...
for(int i = 10; i <= 20; i++){
      ...
      out.write("\t\t\t\t\t\t\t원칙3. 동물보상에서는 우선순위가 있어서 젤 앞에것을 높은 놈을 설정하세요.<br>\r\n");
      out.write("\t\t\t\t\t\t\t원칙4. SKT(1), GOOGLE(5), NHN(6), IPHONE(7)</font><br>\r\n");
      out.write("\t\t\t\t\t\t\t동물 뽑기에 대한 설정을 하는 곳입니다.\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t<td>마켓</td>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t<td>가격 할인</td>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=4>보상(우선순위1/2/3)</td>\r\n");
      out.write("\t\t\t\t\t\t<td>확률상승</td>\r\n");
      out.write("\t\t\t\t\t\t<td>무료교배</td>\r\n");
      out.write("\t\t\t\t\t\t<td>보물강화할인</td>\r\n");
...
if(cstmt.getMoreResults()){
      ...
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"p1\" value=\"30\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"p2\" value=\"6\">\r\n");
      ...
      out.write("\" size=\"4\" maxlength=\"4\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"> -> <br>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"d5\" type=\"text\" value=\"");
      out.print(result.getInt("roulreward1"));
      out.write("\" size=\"4\" maxlength=\"4\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"> X\r\n");
      ...
      out.write("\" size=\"40\" maxlength=\"128\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"image\" type=\"image\" src=\"images/btn_send.gif\" border=\"0\" tabindex=\"3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
