...
public final class systemroul_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t할인은 마스터에서 관리합니다.\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<font size=10>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=systemroul_list.jsp?packstate=-1>삭제보기</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=systemroul_list.jsp?packstate=1>정상보기</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t</font>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t<td>상품</td>\r\n");
      out.write("\t\t\t\t\t\t<td><a href=systemroul_list.jsp?packstate=");
...
if(cnt > 0){
      ...
      out.write(")<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t허용렙 : <input name=\"p4\" type=\"text\" value=\"");
      ...
      out.write("\" size=\"3\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t->\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img src=item/gc.png><input name=\"p9\" type=\"text\" value=\"");
      out.print(result.getString("gamecost"));
      out.write("\" size=\"5\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img src=item/ht.png><input name=\"p10\" type=\"text\" value=\"");
      ...
      out.write("\" size=\"40\" maxlength=\"50\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!--");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>1번그룹</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>2번그룹</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>3번그룹</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>4번그룹</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>5번그룹</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
