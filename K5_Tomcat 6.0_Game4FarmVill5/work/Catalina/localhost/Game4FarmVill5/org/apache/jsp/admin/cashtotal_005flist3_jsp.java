...
public final class cashtotal_005flist3_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	try{
      ...
      out.write("\t\t\t\t\t\t\t일별 유니크 캐쉬 구매(일자별 구매내역별 정렬)<br>\r\n");
      out.write("\t\t\t\t\t\t\t(* iPhone 구매는 달러이면 계산 편의상 원으로 환산된것입니다.)<br>\r\n");
      out.write("\t\t\t\t\t\t\t전일것은 스케쥴링 합니다.\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t");
					...
					//2. 데이타 조작
					//exec spu_FarmD 21, 14,-1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''						-- 캐쉬유니크통계
					//exec spu_FarmD 21, 14,-1, -1, -1, -1, -1, -1, -1, -1, '', '20140408', '', '', '', '', '', '', '', ''				--
...
while(result.next()){
      ...
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print((dateid != result.getInt("dateid"))?result.getString("dateid"):"");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
