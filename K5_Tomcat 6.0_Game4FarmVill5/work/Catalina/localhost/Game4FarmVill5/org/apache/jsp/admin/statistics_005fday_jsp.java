...
public final class statistics_005fday_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	try{
      ...
      out.write("\t\t\t\t\t");
					...
					//2. 데이타 조작
					//exec spu_FarmD 21, 1, -1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''			-- 일별통계
      ...
      out.write("\t\t\t\t\t\t\t<td>마켓</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<td>계정생성</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>유니크가입<br>(폰당)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>로그인<br>(중복)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>로그인<br>(비중복)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td bgcolor=yellow>카카오<br>초대/하트전송/도와줘</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<td>하트사용량</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>동물뽑기<br>(일/프/프10)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>보물뽑기<br>(일/프/프10)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>강화<br>(동물/보물하트/보물캐쉬)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>합성<br>(코인/캐쉬)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>승급</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>부활<br>(템/루비)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>Push<br>(A/I)</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>쿠폰등록</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>복귀<br>요청/복귀</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<td>거래수/배틀/횟수구매/유저배틀</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t캐쉬구매<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t일반/생애\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t짜요쿠폰조각등장<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t거래/박스/건초/하트\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!--");
      out.print(result.getString("joinplayercnt"));
      out.write("-->\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("joinguestcnt"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("joinukcnt"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("logincnt"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("logincnt2"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td bgcolor=yellow>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("invitekakao"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t/ ");
      out.print(result.getString("kakaoheartcnt"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t/ ");
      out.print(result.getString("kakaohelpcnt"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("heartusecnt"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("freeroulettcnt"));
      out.write(' ');
      out.write('/');
      out.write(' ');
      out.print(result.getString("payroulettcnt"));
      out.write(' ');
      out.write('/');
      out.write(' ');
      out.print(result.getString("payroulettcnt2"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("freetreasurecnt"));
      out.write(' ');
      out.write('/');
      out.write(' ');
      out.print(result.getString("paytreasurecnt"));
      out.write(' ');
      out.write('/');
      out.write(' ');
      out.print(result.getString("paytreasurecnt2"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("aniupgradecnt"));
      out.write(' ');
      out.write('/');
      out.write(' ');
      out.print(result.getString("tsupgradenor"));
      out.write(' ');
      out.write('/');
      out.write(' ');
      out.print(result.getString("tsupgradepre"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("freeanicomposecnt"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t/ ");
      out.print(result.getString("payanicomposecnt"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("anipromotecnt"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("revivalcnt"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t/ ");
      out.print(result.getString("revivalcntcash"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("pushandroidcnt"));
      out.write(' ');
      out.write('/');
      out.write(' ');
      out.print(result.getString("pushiphonecnt"));
      out.write(" </td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("certnocnt"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("rtnrequest"));
      out.write('/');
      out.print(result.getString("rtnrejoin"));
      out.write("</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write(" /\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("battlecnt"));
      out.write(" /\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("playcntbuy"));
      out.write(" /\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("userbattlecnt"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("cashcnt"));
      out.write(" /\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("cashcnt2"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("boxopenopen"));
      out.write(" /\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("boxopencash"));
      out.write(" /\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("boxopentriple"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("wheelnor"));
      out.write(" /\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("wheelpre"));
      out.write(" /\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("wheelprefree"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("zcpcntfree"));
      out.write(" /\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("zcpcntcash"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("zcpappeartradecnt"));
      out.write(" /\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("zcpappearboxcnt"));
      out.write(" /\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("zcpappearfeedcnt"));
      out.write(" /\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("zcpappearheartcnt"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t<a href=statistics_day.jsp?idxPage=");
