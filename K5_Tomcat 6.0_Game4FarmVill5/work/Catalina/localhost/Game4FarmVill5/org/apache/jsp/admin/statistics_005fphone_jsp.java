...
public final class statistics_005fphone_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	try{
      ...
      out.write("\tif(f_nul_chk(f.phone, '아이디를')) return false;\r\n");
      ...
      out.write("\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"statistics_phone.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=4>\r\n");
      out.write("\t\t\t\t\t\t유저 유니크 가입체킹(와일드검색은 100건까지)\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td> 폰번호[");
      ...
      out.write("\t\t\t\t\t");
					...
					//2. 데이타 조작
					//exec spu_FarmD 19, 300,-1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''						-- 유니크 가입폰리스트
					//exec spu_FarmD 19, 300,-1, -1, -1, -1, -1, -1, -1, -1, '', '', '01011112223', '', '', '', '', '', '', ''			--
					query.append("{ call dbo.spu_FarmD (?, ?, ?, ?, ?,   ?, ?, ?, ?, ?,   ?, ?, ?, ?, ?,   ?, ?, ?, ?, ?)} ");
					cstmt = conn.prepareCall(query.toString());
					cstmt.setInt(idxColumn++, 19);
					cstmt.setInt(idxColumn++, 300);
      ...
      out.write("\t\t\t\t\t\t\t<td>폰번호</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>마켓</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>가입횟수</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>최초가입일</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t");
while(result.next()){
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><a href=statistics_phone.jsp?phone=");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("joincnt"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
