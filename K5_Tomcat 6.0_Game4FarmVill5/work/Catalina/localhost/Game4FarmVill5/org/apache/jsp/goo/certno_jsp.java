...
public final class certno_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("utf-8");
	...
	try{
		//2. 데이타 조작
		//exec sup_CheckCertNo 'xxxx2', '049000s1i0n7t8445289', 'D50C7E8A83F246D2', -1	-- 아이디 존재안함
		query.append("{ call dbo.sup_CheckCertNo (?, ?, ?, ?)} ");
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_CERTNO); 						msg.append("</code>\n");
