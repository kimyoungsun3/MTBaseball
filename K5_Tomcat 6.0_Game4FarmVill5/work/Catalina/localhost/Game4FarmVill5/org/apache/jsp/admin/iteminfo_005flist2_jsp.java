...
public final class iteminfo_005flist2_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t\t\t\t\t<td>param2</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>param3</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>param4</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>param10</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t");
while(result.next()){
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(checkImgParam(view, result.getInt("subcategory"), 2, result.getString("param2"), imgroot));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
