...
public final class systemvip_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
		//2. 데이타 조작
		//exec spu_FarmD 30, 70, -1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''
      ...
      out.write("\t\t    + '6:' + f.pack6.value + ';'\r\n");
      out.write("\t\t    + '7:' + f.pack7.value + ';'\r\n");
      out.write("\t\t    + '8:' + f.pack8.value + ';'\r\n");
      out.write("\t\t    + '9:' + f.pack9.value + ';'\r\n");
      ...
      out.write("\t\t\t\t낙농포인트 = 캐쉬포인트  (1원당 1포인트)\r\n");
      out.write("\t\t\t\t<table border=1>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>idx</td>\r\n");
      out.write("\t\t\t\t\t\t<td>vip_grade</td>\r\n");
      out.write("\t\t\t\t\t\t<td>vip_cashpoint</td>\r\n");
      out.write("\t\t\t\t\t\t<td>vip_cashplus</td>\r\n");
      out.write("\t\t\t\t\t\t<td>vip_gamecost</td>\r\n");
      out.write("\t\t\t\t\t\t<td>vip_heart</td>\r\n");
      out.write("\t\t\t\t\t\t<td>vip_animal10</td>\r\n");
      out.write("\t\t\t\t\t\t<td>vip_wheel10</td>\r\n");
      out.write("\t\t\t\t\t\t<td>vip_treasure10</td>\r\n");
      out.write("\t\t\t\t\t\t<td>vip_box</td>\r\n");
      out.write("\t\t\t\t\t\t<td>vip_fbplus</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
while(result.next()){
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr ");
      out.print( (result.getInt("idx") % 2 == 0) ? "bgcolor=#aaffaa":"");
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"usersetting_ok.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"branch\" value=\"systemvip_list\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"p1\" value=\"30\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"p2\" value=\"71\">\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(result.getString("vip_grade"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(result.getString("vip_cashpoint"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(result.getString("vip_cashplus"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(result.getString("vip_gamecost"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(result.getString("vip_heart"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(result.getString("vip_animal10"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(result.getString("vip_wheel10"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(result.getString("vip_treasure10"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(result.getString("vip_box"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(result.getString("vip_fbplus"));
      out.write("</td>\r\n");
