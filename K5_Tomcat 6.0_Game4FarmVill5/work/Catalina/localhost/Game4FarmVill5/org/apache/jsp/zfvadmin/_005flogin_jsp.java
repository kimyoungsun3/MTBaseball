package org.apache.jsp.zfvadmin;
...
request.setCharacterEncoding("EUC-KR");
	...
	String servername = "<font color=gray size=5>짜요 타이쿤 for Kakao(Test)</font>";
	String strIP = request.getLocalAddr();
	if(!strIP.equals("192.168.0.11")){
		servername = "<font color=red size=5>짜요 타이쿤 for Kakao</font>";
	}
