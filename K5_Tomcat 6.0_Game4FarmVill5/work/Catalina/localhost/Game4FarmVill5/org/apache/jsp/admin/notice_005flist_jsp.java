...
public final class notice_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	try{
      ...
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"notice_ok.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t\t<input type=\"hidden\" name=\"subkind\" value=\"0\">\r\n");
      out.write("\t\t\t\t<input type=\"hidden\" name=\"buytype\" value=\"0\">\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t[공지사항]\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<font color=red>- 상태:점검중으로 선택하면 해당 통신사 모든 유저 로그인불가</font><br>\r\n");
      out.write("\t\t\t\t\t\t\t<!--<a href=fileupload.jsp>이미지UpLoad(PNG)</a> <br><br>-->\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t판매처 :\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"market\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t");
for(int i = 0; i < market.length; i+=2){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t상태 :\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"syscheck\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"0\">서비스중(0)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"1\">점검중..(1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t버젼 : <input name=\"version\" type=\"text\" value=\"101\" maxlength=\"3\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:100px;\"><br>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\titeminfo version : <input name=\"iteminfover\" type=\"text\" value=\"101\" maxlength=\"3\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:100px;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t<!--iteminfo URL\t: <input name=\"iteminfourl\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\">-->\r\n");
      out.write("\t\t\t\t\t\t\t<a href=fileupload.jsp target=_blank>(파일올리기)</a>\r\n");
      out.write("\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t공지 이미지\t\t: <input name=\"comfile\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t공지 URL\t\t: <input name=\"comurl\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><a href=fileupload.jsp target=_blank>(파일올리기)</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t공지2 이미지\t: <input name=\"comfile2\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t공지2 URL\t\t: <input name=\"comurl2\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><a href=fileupload.jsp target=_blank>(파일올리기)</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t공지3 이미지\t: <input name=\"comfile3\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t공지3 URL\t\t: <input name=\"comurl3\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><a href=fileupload.jsp target=_blank>(파일올리기)</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t공지4 이미지\t: <input name=\"comfile4\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t공지4 URL\t\t: <input name=\"comurl4\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><a href=fileupload.jsp target=_blank>(파일올리기)</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t공지5 이미지\t: <input name=\"comfile5\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t공지5 URL\t\t: <input name=\"comurl5\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><a href=fileupload.jsp target=_blank>(파일올리기)</a><br>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t패치URL\t\t\t: <input name=\"patchurl\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t게시판URL\t\t: <input name=\"recurl\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t커뮤니티URL\t\t: <input name=\"communityurl\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t잦은질문URL\t\t: <input name=\"serviceurl\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t<!--\r\n");
      out.write("\t\t\t\t\t\t\tSMSURL\t\t\t: <input name=\"smsurl\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\tSMS내용\t\t\t: <input name=\"smscom\" type=\"text\" value=\"\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:450px;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t-->\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td style=\"padding-left:5px;\">\r\n");
      out.write("\t\t\t\t\t\t\t<textarea name=\"comment\" rows=\"10\" cols=\"120\" style=\"border:solid 1px black; font-family:tahoma; background-color:lightsteelblue;\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
...
while(result.next()){
      ...
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"notice_ok.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" name=\"subkind\" value=\"1\">\r\n");
      out.write("\t        \t\t\t\t<input type=\"hidden\" name=\"idx\" value=\"");
      out.print(result.getString("idx"));
      out.write("\">\r\n");
      out.write("\t        \t\t\t\t<input type=\"hidden\" name=\"market\" value=\"");
      out.print(result.getString("market"));
      out.write("\">\r\n");
      out.write("\t        \t\t\t\t<input type=\"hidden\" name=\"buytype\" value=\"");
      out.print(result.getString("buytype"));
      out.write("\">\r\n");
      out.write("\t        \t\t\t\t<input type=\"hidden\" name=\"iteminfourl\" value=\"");
      out.print(result.getString("iteminfourl"));
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t<td ");
      ...
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<table ");
      out.print(getCheckValueOri(result.getInt("syscheck"), 1, "bgcolor=#aa00aa", ""));
      out.write(" valign=top>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>서비스</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      ...
      out.print(getSelect(result.getInt("syscheck"), 0));
      out.write(">서비스중(0)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"1\" ");
      out.print(getSelect(result.getInt("syscheck"), 1));
      out.write(">점검중..(1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>버 젼</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"version\" type=\"text\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>iteminfo version</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"iteminfover\" type=\"text\" value=\"");
      out.print(result.getString("iteminfover"));
      out.write("\" size=\"3\" maxlength=\"3\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>공지1</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"comfile\" type=\"text\" value=\"");
      out.print(result.getString("comfile"));
      out.write("\" size=\"100\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><a href=fileupload.jsp target=_blank>(파일올리기)</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"comurl\" type=\"text\" value=\"");
      out.print(result.getString("comurl"));
      out.write("\" size=\"100\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(result.getString("comurl").equals("")?"":"<a href="+(result.getString("comurl") + " target=_blank>"));
      out.write("<img src=\"");
      out.print(result.getString("comfile"));
      out.write("\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<td>공지2</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"comfile2\" type=\"text\" value=\"");
      out.print(result.getString("comfile2"));
      out.write("\" size=\"100\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><a href=fileupload.jsp target=_blank>(파일올리기)</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"comurl2\" type=\"text\" value=\"");
      out.print(result.getString("comurl2"));
      out.write("\" size=\"100\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(result.getString("comurl2").equals("")?"":"<a href="+(result.getString("comurl2") + " target=_blank>"));
      out.write("<img src=\"");
      out.print(result.getString("comfile2"));
      out.write("\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<td>공지3</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"comfile3\" type=\"text\" value=\"");
      out.print(result.getString("comfile3"));
      out.write("\" size=\"100\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><a href=fileupload.jsp target=_blank>(파일올리기)</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"comurl3\" type=\"text\" value=\"");
      out.print(result.getString("comurl3"));
      out.write("\" size=\"100\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(result.getString("comurl3").equals("")?"":"<a href="+(result.getString("comurl3") + " target=_blank>"));
      out.write("<img src=\"");
      out.print(result.getString("comfile3"));
      out.write("\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<td>공지4</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"comfile4\" type=\"text\" value=\"");
      out.print(result.getString("comfile4"));
      out.write("\" size=\"100\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><a href=fileupload.jsp target=_blank>(파일올리기)</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"comurl4\" type=\"text\" value=\"");
      out.print(result.getString("comurl4"));
      out.write("\" size=\"100\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(result.getString("comurl4").equals("")?"":"<a href="+(result.getString("comurl4") + " target=_blank>"));
      out.write("<img src=\"");
      out.print(result.getString("comfile4"));
      out.write("\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<td>공지5</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"comfile5\" type=\"text\" value=\"");
      out.print(result.getString("comfile5"));
      out.write("\" size=\"100\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><a href=fileupload.jsp target=_blank>(파일올리기)</a><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"comurl5\" type=\"text\" value=\"");
      out.print(result.getString("comurl5"));
      out.write("\" size=\"100\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(result.getString("comurl5").equals("")?"":"<a href="+(result.getString("comurl5") + " target=_blank>"));
      out.write("<img src=\"");
      out.print(result.getString("comfile5"));
      out.write("\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>패치 URL</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"patchurl\" type=\"text\" value=\"");
      out.print(result.getString("patchurl"));
      out.write("\" size=\"100\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>추천 게시판URL</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"recurl\" type=\"text\" value=\"");
      out.print(result.getString("recurl"));
      out.write("\" size=\"100\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>커뮤니티URL</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"communityurl\" type=\"text\" value=\"");
      out.print(result.getString("communityurl"));
      out.write("\" size=\"100\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>잦은질문URL</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"serviceurl\" type=\"text\" value=\"");
      out.print(result.getString("serviceurl"));
      out.write("\" size=\"100\" maxlength=\"512\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>텍스트 공지</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<textarea name=\"comment\" rows=\"10\" cols=\"120\" style=\"border:solid 1px black; font-family:tahoma; background-color:lightsteelblue;\">");
