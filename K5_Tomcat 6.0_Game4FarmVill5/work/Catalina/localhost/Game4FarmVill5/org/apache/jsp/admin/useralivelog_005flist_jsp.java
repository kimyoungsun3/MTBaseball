...
public final class useralivelog_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"useralivelog_list.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=4>\r\n");
      out.write("\t\t\t\t\t\t\t유저 동물부활 로그(루비, 부활석), 친구부활, 무료기간(2013) 빠짐\r\n");
      out.write("\t\t\t\t\t\t\t<a href=useralivelog_list.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>계정</td>\r\n");
      ...
      out.write("\t\t\t\t\t");
					...
					//2. 데이타 조작
					//exec spu_FarmD 19, 406,-1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''						-- 유저 동물부활 로그
					//exec spu_FarmD 19, 406,-1, -1, -1, -1, -1, -1, -1, -1, 'xxxx2', '', '', '', '', '', '', '', '', ''				--
      ...
      out.write("\t\t\t\t\t\t\t<td>죽은시간</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>머리악세</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>꼬리악세</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><font color=red>부활시간</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><font color=red>부활석사용량</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><font color=red>부활루비사용량</a></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t");
while(result.next()){
...
if(result.getInt("invenkind") == 3){
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getInt("needhelpcnt"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("diedate"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("alivedate"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("alivedoll"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("alivecash"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t");
}
