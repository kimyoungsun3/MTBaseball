...
request.setCharacterEncoding("utf-8");
	...
	try{
		//2. 데이타 조작
		//exec spu_Friend 'xxxx', '049000s1i0n7t8445289',  1, -1, '', 	 -1		-- 검색 : 랜덤검색
		//exec spu_Friend 'xxxx', '049000s1i0n7t8445289', 1, 'DD', -1		-- 검색 : 이웃 > 0초
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_FSEARCH); 			msg.append("</code>\n");
