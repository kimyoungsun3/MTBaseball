...
public final class eventdailyuser_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"eventdailyuser_list.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=3>\r\n");
      out.write("\t\t\t\t\t\t\t일일 선물받아간 사람 <a href=eventdailyuser_list.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<td>검색</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>번호</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>서버번호</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>이벤트번호</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>아이템</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>획득일</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
...
while(result.next()){
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><a href=eventdailyuser_list.jsp?gameid=");
      ...
      out.write('(');
      out.print(result.getString("eventitemcode"));
      out.write(")\r\n");
      out.write("\t\t\t\t\t\t\t\tx\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(result.getString("eventcnt"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=usersetting_ok.jsp?p1=19&p2=66&p3=12&p4=");
      out.print(result.getString("idx"));
      out.write("&ps1=");
      out.print(result.getString("gameid"));
      out.write("&branch=eventdailyuser_list&gameid=");
      out.print(result.getString("gameid"));
      out.write(">개발삭제</a>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<a href=eventdailyuser_list.jsp?idxPage=");
