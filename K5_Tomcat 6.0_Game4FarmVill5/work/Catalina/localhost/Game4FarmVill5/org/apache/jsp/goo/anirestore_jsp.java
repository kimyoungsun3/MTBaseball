...
public final class anirestore_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("utf-8");
	...
	try{
		...
		query.append("{ call dbo.spu_AniRestore (?, ?, ?)} ");
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_ANIRESTORE); 		msg.append("</code>\n");
