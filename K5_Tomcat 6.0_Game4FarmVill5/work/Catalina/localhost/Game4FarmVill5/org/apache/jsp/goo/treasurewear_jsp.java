...
public final class treasurewear_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("utf-8");
	...
	try{
		...
		query.append("{ call spu_RoulTreasureWear (?, ?, ?, ?)} ");
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_TREASUREWEAR); 					msg.append("</code>\n");
		...
		msg.append("		<tslistidx1>");		msg.append(result.getInt("tslistidx1"));    	msg.append("</tslistidx1>\n");
		msg.append("		<tslistidx2>");		msg.append(result.getInt("tslistidx2"));    	msg.append("</tslistidx2>\n");
		msg.append("		<tslistidx3>");		msg.append(result.getInt("tslistidx3"));    	msg.append("</tslistidx3>\n");
		msg.append("		<tslistidx4>");		msg.append(result.getInt("tslistidx4"));    	msg.append("</tslistidx4>\n");
		msg.append("		<tslistidx5>");		msg.append(result.getInt("tslistidx5"));    	msg.append("</tslistidx5>\n");
		msg.append("	</result>\n");
	    msg.append("</rows>\n");
	}catch(Exception e){
		System.out.println("==============================");
