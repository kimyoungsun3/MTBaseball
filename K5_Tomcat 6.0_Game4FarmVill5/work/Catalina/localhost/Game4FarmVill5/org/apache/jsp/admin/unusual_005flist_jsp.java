...
public final class unusual_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"unusual_list.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=4>\r\n");
      out.write("\t\t\t\t\t\t\t유저들이 하는 부정행위 정보가 들어가 있음 <a href=unusual_list.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t");
					...
					//2. 데이타 조작
					//exec spu_FarmD 19, 1003, -1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''					-- 이상행동정보.
					//exec spu_FarmD 19, 1003, -1, -1, -1, -1, -1, -1, -1, -1, 'xxxx2', '', '', '', '', '', '', '', '', ''				--
					query.append("{ call dbo.spu_FarmD (?, ?, ?, ?, ?,   ?, ?, ?, ?, ?,   ?, ?, ?, ?, ?,   ?, ?, ?, ?, ?)} ");
					cstmt = conn.prepareCall(query.toString());
					cstmt.setInt(idxColumn++, 19);
					cstmt.setInt(idxColumn++, 1003);
...
while(result.next()){
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><a href=unusual_list.jsp?gameid=");
      ...
      out.write("\t\t\t\t\t\t\t\t<a href=usersetting_ok.jsp?p1=19&p2=1005&p3=");
      out.print(result.getString("idx"));
      out.write("&ps1=");
      out.print(result.getString("gameid"));
      out.write("&ps2=");
      out.print(adminid);
      out.write("&branch=unusual_list&gameid=");
      out.print(result.getString("gameid"));
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t삭제\r\n");
      out.write("\t\t\t\t\t\t\t\t</a>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<a href=unusual_list.jsp?idxPage=");
