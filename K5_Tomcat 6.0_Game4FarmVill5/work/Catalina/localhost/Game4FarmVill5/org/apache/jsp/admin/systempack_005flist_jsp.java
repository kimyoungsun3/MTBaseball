...
public final class systempack_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
		//2. 데이타 조작
		//exec spu_FarmD 30, 11, -1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''								-- 패키지상품(아이템리스트).
      ...
      out.write("\tvar ps3 = '1:' + f.pack1.value + ';'\r\n");
      out.write("\t\t    + '2:' + f.pack2.value + ';'\r\n");
      out.write("\t\t    + '3:' + f.pack3.value + ';'\r\n");
      out.write("\t\t    + '4:' + f.pack4.value + ';'\r\n");
      out.write("\t\t    + '5:' + f.pack5.value + ';'\r\n");
      out.write("\tf.ps3.value = ps3;\r\n");
      ...
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"p2\" value=\"12\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"p3\" value=\"-1\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"ps3\" value=\"\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"branch\" value=\"systempack_list\">\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t패키지명:<input name=\"ps1\" type=\"text\" value=\"\" size=\"30\" maxlength=\"256\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t(* 500xx대역에 신규 아이템이 추가됩니다.)<br>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t허용레벨:\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"p4\" type=\"text\" value=\"1\" size=\"4\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t~\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"p5\" type=\"text\" value=\"50\" size=\"4\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
...
for(int i = 0; i < cnt; i++){
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t캐쉬:<input name=\"p6\" type=\"text\" value=\"30\" size=\"4\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t활인:<input name=\"p7\" type=\"text\" value=\"0\" size=\"4\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">(%)\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"p8\" >\r\n");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t코멘트:<input name=\"ps2\" type=\"text\" value=\"\" size=\"30\" maxlength=\"256\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\tSKT(1), GOOGLE(5), NHN(6), IPHONE(7)\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>idx</td>\r\n");
      out.write("\t\t\t\t\t\t<td>패키지명</td>\r\n");
      out.write("\t\t\t\t\t\t<td>허용레벨</td>\r\n");
      out.write("\t\t\t\t\t\t<td>패키지상품</td>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t<td>캐쉬\r\n");
      out.write("\t\t\t\t\t\t\t<a href=systempack_list.jsp?packstate=");
      out.print(packstate==1?-1:1);
      out.write('>');
      out.print(packstate==1?"삭제보기":"정상보기");
      out.write("</a>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
...
if(cnt > 0){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr ");
      out.print(getCheckValueOri(result.getInt("packstate"), -1, "bgcolor=#aaaaaa", ""));
      out.write(' ');
      ...
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"p1\" value=\"30\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"p2\" value=\"13\">\r\n");
      ...
      out.print(result.getString("packname"));
      out.write("\" size=\"16\" maxlength=\"256\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t(");
      out.print(result.getString("itemcode"));
      out.write(")<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input name=\"ps4\" type=\"text\" value=\"");
      out.print(result.getString("packmarket"));
      out.write("\" size=\"16\" maxlength=\"256\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t허용레벨 : <input name=\"p4\" type=\"text\" value=\"");
      out.print(result.getString("famelvmin"));
      out.write("\" size=\"1\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t~\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input name=\"p5\" type=\"text\" value=\"");
      out.print(result.getString("famelvmax"));
      out.write("\" size=\"1\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img src=item/cc.png><input name=\"p6\" type=\"text\" value=\"");
      out.print(result.getString("cashcostcost"));
      out.write("\" size=\"2\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input name=\"p7\" type=\"text\" value=\"");
      out.print(result.getString("cashcostper"));
      out.write("\" size=\"2\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">(%)\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t-> 판매 ");
      out.print(result.getString("cashcostsale"));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<select name=\"p8\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<option value=\"-1\" ");
      out.print(getSelect(result.getInt("packstate"), -1));
      ...
      out.write("\" size=\"50\" maxlength=\"50\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!--");
...
for(int kk = 1; kk <= 5; kk++){
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"pack");
      out.print(kk);
      out.write("\" type=\"text\" value=\"");
      out.print(result.getInt("pack" + kk));
      out.write("\" size=\"5\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
...
for(int i = 0; i < 5; i++){
      ...
      out.print(imgroot);
      out.write('/');
      out.print(result.getInt("pack" + (i+1)));
      out.write(".png></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
}
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<input name=\"image\" type=\"image\" src=\"images/btn_send.gif\" border=\"0\" tabindex=\"3\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t원가 : (");
      out.print(cashcost);
      out.write(" 루비) (");
      out.print(gamecost);
