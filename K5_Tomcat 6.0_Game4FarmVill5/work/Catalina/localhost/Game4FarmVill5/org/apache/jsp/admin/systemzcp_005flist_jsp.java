...
public final class systemzcp_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<a href=systemzcp_list.jsp?view=0>전체보기</a>\r\n");
      out.write("\t\t\t\t");
for(int i = 0; i < kind.length; i+=2){
      out.write("\r\n");
      out.write("\t\t\t\t\t&nbsp;&nbsp;&nbsp;<a href=systemzcp_list.jsp?viewkind=");
      out.print(kind[i]);
      out.write('>');
      out.print(kind[i+1]);
      out.write("</a>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t&nbsp;&nbsp;&nbsp;<a href=systemzcp_list.jsp?view=1>입력보기</a>\r\n");
      out.write("\t\t\t\t");
if(view == 1){
      out.write("\r\n");
      out.write("\t\t\t\t<table>\r\n");
      ...
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"branch\" value=\"systemzcp_list\">\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>타이틀</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
...
for(int i = 0; i < newmark.length; i+=2){
      ...
      out.write("\" size=\"50\" maxlength=\"256\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select name=\"d6\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
