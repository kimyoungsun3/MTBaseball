...
public final class userdelete_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	try{
      ...
      out.write("\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"userdelete_list.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=4>\r\n");
      out.write("\t\t\t\t\t\t\t1. 환급 유저<br>\r\n");
      out.write("\t\t\t\t\t\t\t- 유저가 자신의 계정을 삭제하는 경우<br>\r\n");
      out.write("\t\t\t\t\t\t\t- 환급을 받고 싶을 때 계정 삭제를 유저에게 요청후 환급 처리하시면 됩니다.<br>\r\n");
      out.write("\t\t\t\t\t\t\t2. 잘못 삭제된 유저 복구<br>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td> 삭제요청자</td>\r\n");
      out.write("\t\t\t\t\t\t<td> 검색</td>\r\n");
...
while(result.next()){
      ...
      out.write("\t\t\t\t\t\t\t<input name=p2 type=hidden value=13>\r\n");
      ...
      out.print(adminip);
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t<input name=branch type=hidden value=userdelete_list>\r\n");
      ...
      out.print(result.getString("idx"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><a href=userdelete_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write('>');
      out.print(result.getString("gameid"));
      out.write("</a></td>\r\n");
