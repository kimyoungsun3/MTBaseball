...
public final class wgiftsend_005fform_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	try{
      ...
      out.write("<tbody><tr>\r\n");
      out.write("        <td colspan=\"2\" height=\"200\" align=\"center\" style=\"vertical-align:middle;\">\r\n");
      out.write("        \t<table>\r\n");
      out.write("        \t\t<tbody>\r\n");
      out.write("        \t\t<tr>\r\n");
      out.write("        \t\t\t<td align=\"center\">\r\n");
      out.write("\t        \t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"wgiftsend_ok.jsp\" onsubmit=\"return checkForm2(this);\">\r\n");
      out.write("\t        \t\t\t<input type=\"hidden\" name=\"subkind\" value=\"11\">\r\n");
      ...
      out.write("\t        \t\t\t\t\t\t\t1. 선물만 발송이 됩니다.(쪽지와 혼동 하시지 말아주세요. )<br>\r\n");
      out.write("\t        \t\t\t\t\t\t\t2. 특수탄 x 10발 > 특수탄 선택후 10을 입력해주세요.<br>\r\n");
      out.write("\t        \t\t\t\t\t\t\t3. 짜요쿠폰조각(최대99), 짜요쿠폰(최대1개)까지만 선물됩니다.<br>\r\n");
      out.write("\t        \t\t\t\t\t\t\t4. 동물, 세포, 보물을 최대수량은 1개까지만 선물됩니다.<br>\r\n");
      out.write("\t        \t\t\t\t\t\t</font>\r\n");
      out.write("\t        \t\t\t\t\t</td>\r\n");
      out.write("\t        \t\t\t\t</tr>\r\n");
      out.write("\t        \t\t\t\t<tr>\r\n");
      out.write("\t        \t\t\t\t\t<td>선물할 유저아이디</td>\r\n");
      ...
      out.write("\t        \t\t\t\t\t<td rowspan=\"2\" style=\"padding-left:5px;\">\r\n");
      ...
      out.write("\t        \t\t\t\t\t<td>\r\n");
      out.write("\t        \t\t\t\t\t<select name=\"itemcode\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
...
while(result.next()){
      ...
      out.write(")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t[");
      out.print(getCategory(result.getInt("category")));
      out.write(' ');
      out.write('/');
      out.write(' ');
      out.print(getSubCategory(result.getInt("subcategory")));
      out.write("]&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write(" /\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t판매:");
      out.print(result.getInt("sellcost"));
      out.write("코인)&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</option>\r\n");
      ...
      out.write("\t        \t\t\t\t\t<td>수량</td>\r\n");
      out.write("\t        \t\t\t\t\t<td>\r\n");
      out.write("\t        \t\t\t\t\t\t<input name=\"cnt\" type=\"text\" value=\"1\" maxlength=\"9\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:154px;\">\r\n");
      out.write("\t        \t\t\t\t\t\t(수량 맥스는 9자리까지만 지원됩니다.)\r\n");
      out.write("\t        \t\t\t\t\t</td>\r\n");
      out.write("\t        \t\t\t\t</tr>\r\n");
      ...
      out.write("        \t\t\t<td align=\"center\">\r\n");
      out.write("\t        \t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"wgiftsend_ok.jsp\" onsubmit=\"return checkForm2(this);\">\r\n");
      out.write("\t        \t\t\t<input type=\"hidden\" name=\"subkind\" value=\"12\">\r\n");
      out.write("\t        \t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t        \t\t\t\t<table>\r\n");
      out.write("\t        \t\t\t\t<tbody>\r\n");
      out.write("\t        \t\t\t\t<tr>\r\n");
      out.write("\t        \t\t\t\t\t<td colspan=3>\r\n");
      out.write("\t        \t\t\t\t\t\t<font color=red>쪽지만 발송됩니다.(위의 기능과 병행 발송 안됩니다.)</font><br>\r\n");
      out.write("\t        \t\t\t\t\t</td>\r\n");
      out.write("\t        \t\t\t\t</tr>\r\n");
      out.write("\t        \t\t\t\t<tr>\r\n");
      out.write("\t        \t\t\t\t\t<td>쪽지(ID)</td>\r\n");
      out.write("\t        \t\t\t\t\t<td><input name=\"gameid\" type=\"text\" value=\"");
      out.print(gameid);
      out.write("\" maxlength=\"20\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:154px;\"></td>\r\n");
      out.write("\t        \t\t\t\t\t<td rowspan=\"2\" style=\"padding-left:5px;\">\r\n");
      out.write("\t        \t\t\t\t\t\t<input name=\"image\" type=\"image\" src=\"images/btn_send.gif\" border=\"0\" tabindex=\"3\">\r\n");
      out.write("\t        \t\t\t\t\t</td>\r\n");
      out.write("\t        \t\t\t\t</tr>\r\n");
      out.write("\t        \t\t\t\t<tr>\r\n");
      out.write("\t        \t\t\t\t\t<td>쪽지(내용)</td>\r\n");
      out.write("\t        \t\t\t\t\t<td colspan=2><input name=\"message\" type=\"text\" value=\"\" maxlength=\"128\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:600px;\"></td>\r\n");
      out.write("\t        \t\t\t\t</tr>\r\n");
      out.write("\t        \t\t\t\t</tbody></table>\r\n");
      out.write("\t        \t\t\t</div>\r\n");
      out.write("\t        \t\t\t</form>\r\n");
