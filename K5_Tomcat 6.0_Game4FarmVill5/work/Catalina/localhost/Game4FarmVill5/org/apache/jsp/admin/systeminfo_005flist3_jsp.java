...
public final class systeminfo_005flist3_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
		//2. 데이타 조작
		//exec spu_FarmD 30, 8, -1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''
      ...
      out.write("\tvar ps9 = '1:' + f.d1.value + ';'\r\n");
      out.write("\t\t    + '2:' + f.d2.value + ';'\r\n");
      out.write("\t\t    + '3:' + f.d3.value + ';'\r\n");
      out.write("\t\t    + '4:' + f.d4.value + ';'\r\n");
      out.write("\t\t    + '5:' + f.d5.value + ';'\r\n");
      out.write("\t\t    + '6:' + f.d6.value + ';'\r\n");
      out.write("\t\t    + '7:' + f.d7.value + ';'\r\n");
      out.write("\t\t    + '15:' + f.d15.value + ';'\r\n");
      out.write("\t\t    + '16:' + f.d16.value + ';'\r\n");
      out.write("\t\t    + '17:' + f.d17.value + ';'\r\n");
      out.write("\t\t    + '10:' + f.d10.value + ';'\r\n");
      out.write("\t\t    + '11:' + f.d11.value + ';'\r\n");
      out.write("\t\t    + '12:' + f.d12.value + ';'\r\n");
      out.write("\t\t    + '13:' + f.d13.value + ';'\r\n");
      out.write("\t\t    + '14:' + f.d14.value + ';'\r\n");
      out.write("\t\t    + '20:' + f.d20.value + ';'\r\n");
      out.write("\t\t    + '21:' + f.d21.value + ';'\r\n");
      out.write("\t\t    + '22:' + f.d22.value + ';'\r\n");
      out.write("\t\t    + '23:' + f.d23.value + ';'\r\n");
      out.write("\t\t    + '24:' + f.d24.value + ';'\r\n");
      out.write("\t\t    + '25:' + f.d25.value + ';'\r\n");
      out.write("\t\t    + '26:' + f.d26.value + ';'\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<a href=systeminfo_list3.jsp?view=1>입력보기</a><a href=systeminfo_list3.jsp?view=0>그냥보기</a>\r\n");
      out.write("\t\t\t\t");
if(view == 1){
      out.write("\r\n");
      out.write("\t\t\t\t<table>\r\n");
      ...
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"p2\" value=\"9\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"ps9\" value=\"\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"branch\" value=\"systeminfo_list3\">\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>마켓</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\tSKT(1), GOOGLE(5), IPHONE(7)은 구분된다.<br>\r\n");
      out.write("\t\t\t\t\t\t\tSKT만 할때 (1)만하면되고 NHN과 Google만 할때는 (5, 6)<br>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"ps1\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t");
for(int i = 0; i < market.length; i+=2){
      ...
      out.write("\t\t\t\t\t\t\t\t2014-01-01 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;~ 2014-05-24 18:00 (형식1)<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t2014-05-24 18:00 ~ 2014-05-24 23:59 (형식2)(24:00쓰면 오류남)\r\n");
      out.write("\t\t\t\t\t\t\t</font><br>\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"ps2\" type=\"text\" value=\"2014-01-01\" size=\"16\" maxlength=\"16\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t~\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"ps3\" type=\"text\" value=\"2024-01-01 23:59\" size=\"16\" maxlength=\"16\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>할인</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"d23\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"1\">활성(1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"-1\">비활성(-1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"d24\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t");
for(int i = 0; i <= 10; i++){
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"");
      ...
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>보물활성화</td>\r\n");
      out.write("\t\t\t\t\t\t<td>보물 뽑으면 수정지급 활성화.\r\n");
      ...
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>보물/보상</t1d>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t반드시 1번이 보상이 높은 것을 선택하세요.<br>\r\n");
      out.write("\t\t\t\t\t\t\t1. 선택한 보물, 2. 그 보물이 나오면 보상되는 템 3.수량 4. 그때 사람들이 받는 메세지(꼭 입력하세요)<br>\r\n");
      out.write("\t\t\t\t\t\t\t예)보물1(80000) 2. 1000결정(3015)<br>\r\n");
      out.write("\t\t\t\t\t\t\t보물1<select name=\"d2\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t");
for(int i = 0; i < cnt; i++){
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"");
      out.print(itemcode[i]);
      out.write('"');
      out.write('>');
...
for(int i = 0; i < cnt; i++){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t보상수량:<input name=\"d15\" type=\"text\" value=\"1\" size=\"10\" maxlength=\"20\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"ps4\" type=\"text\" value=\"보상제목1\" size=\"20\" maxlength=\"20\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t보물2<select name=\"d3\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t");
for(int i = 0; i < cnt; i++){
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"");
...
for(int i = 0; i < cnt; i++){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t보상수량:<input name=\"d16\" type=\"text\" value=\"1\" size=\"10\" maxlength=\"20\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"ps5\" type=\"text\" value=\"보상제목2\" size=\"20\" maxlength=\"20\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t보물3<select name=\"d4\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t");
for(int i = 0; i < cnt; i++){
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"");
...
for(int i = 0; i < cnt; i++){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t보상수량:<input name=\"d17\" type=\"text\" value=\"1\" size=\"10\" maxlength=\"20\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"ps6\" type=\"text\" value=\"보상제목3\" size=\"20\" maxlength=\"20\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>PM확률활성화</td>\r\n");
      out.write("\t\t\t\t\t\t<td>프리미엄 뽑기의 확률 상승 활성화\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"d10\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"1\">활성(1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"-1\">비활성(-1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>PM확률시간</t1d>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t-1:시간이 없다는 의미<br>\r\n");
      out.write("\t\t\t\t\t\t\t14: 오후 2:00 ~ 2:59까지 작동한다는 의미<br>\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"d11\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t");
for(int i = -1; i < 24; i++){
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"");
...
for(int i = -1; i < 24; i++){
      ...
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>PM무료</td>\r\n");
      out.write("\t\t\t\t\t\t<td>프리미엄 일정횟수 이후 무료뽑기\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"d20\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"1\">활성(1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"-1\">비활성(-1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>PM무료세팅값</t1d>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t10포인트에 100Max는 10회를 하면 1회 무료로 프리미엄을 뽑을 수 있다.\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"d21\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t");
for(int i = 10; i <= 10; i++){
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"");
      ...
      out.write('>');
      out.print(i);
      out.write("포인트</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
}
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"d22\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t");
for(int i = 100; i <= 100; i++){
      ...
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>강화할인</t1d>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"d25\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"1\">활성(1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"-1\">비활성(-1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"d26\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t");
for(int i = 0; i <= 40; i+=5){
      ...
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input name=\"ps10\" type=\"text\" value=\"코멘트\" size=\"40\" maxlength=\"128\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t원칙1. 젤 위에 것만 적용되는것 알아주세요. 통신사을 구분하면 통신사 구분에 따라서 적용됩니다.<br>\r\n");
      out.write("\t\t\t\t\t\t\t원칙2. 리스트 2번 마켓(1,2,3,4,5,6)이러면 7번 마켓은 적용안됨 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t   리스트 1번 마켓(7) 7번 마켓 전용입니다.<br>\r\n");
      out.write("\t\t\t\t\t\t\t원칙3. 보물보상에서는 우선순위가 있어서 젤 앞에것을 높은 놈을 설정하세요.<br>\r\n");
      out.write("\t\t\t\t\t\t\t원칙4. SKT(1), GOOGLE(5), NHN(6), IPHONE(7)</font><br>\r\n");
      out.write("\t\t\t\t\t\t\t보물 뽑기에 대한 설정을 하는 곳입니다.\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td></td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t보상 (보물우선순위1/2/3)\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t<td>보물확률상승</td>\r\n");
      out.write("\t\t\t\t\t\t<td>보물무료뽑기</td>\r\n");
      out.write("\t\t\t\t\t\t<td bgcolor=rosered>보물강화할인</td>\r\n");
...
if(cstmt.getMoreResults()){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<form name=\"GIFTFORM");
      out.print(result.getString("idx"));
      out.write("\" method=\"post\" action=\"usersetting_ok.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"p1\" value=\"30\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"p2\" value=\"10\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"p3\" value=\"");
      out.print(result.getInt("idx"));
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"ps1\" value=\"");
      out.print(result.getString("roulmarket"));
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"ps9\" value=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"branch\" value=\"systeminfo_list3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print(getTel(result.getInt("roulmarket")));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"ps2\" type=\"text\" value=\"");
      out.print(getDate(result.getString("roulstart")));
      out.write("\" size=\"16\" maxlength=\"16\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"ps3\" type=\"text\" value=\"");
      out.print(getDate(result.getString("roulend")));
      out.write("\" size=\"16\" maxlength=\"16\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<br><font color=red>(끝나는 시간은 수정하지 말아주세요!!!)</font>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td ");
      out.print(getCheckValueOri(result.getInt("roulsaleflag"), -1, "bgcolor=#aaaaaa", ""));
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select name=\"d23\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"-1\" ");
      out.print(getSelect(result.getInt("roulsaleflag"), -1));
      out.write(">비활성(-1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"1\" ");
      out.print(getSelect(result.getInt("roulsaleflag"),  1));
      out.write(">활성(1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</select><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"d24\" type=\"text\" value=\"");
      out.print(result.getInt("roulsalevalue"));
      out.write("\" size=\"3\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">%<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td ");
      out.print(getCheckValueOri(result.getInt("roulflag"), -1, "bgcolor=#aaaaaa", ""));
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select name=\"d1\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"-1\" ");
      out.print(getSelect(result.getInt("roulflag"), -1));
      out.write(">비활성(-1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"1\" ");
      out.print(getSelect(result.getInt("roulflag"),  1));
      out.write(">활성(1)</option>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"d2\" type=\"text\" value=\"");
      out.print(result.getInt("roulani1"));
      out.write("\" size=\"6\" maxlength=\"6\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"> -> <br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"d5\" type=\"text\" value=\"");
      out.print(result.getInt("roulreward1"));
      out.write("\" size=\"5\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"> X\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"d15\" type=\"text\" value=\"");
      out.print(result.getInt("roulrewardcnt1"));
      out.write("\" size=\"6\" maxlength=\"6\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"ps4\" type=\"text\" value=\"");
      out.print(result.getString("roulname1"));
      out.write("\" size=\"20\" maxlength=\"20\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br><br><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img src=");
      out.print(imgroot);
      out.write('/');
      out.print(result.getInt("roulani1"));
      out.write(".png> -> <img src=");
      out.print(imgroot);
      out.write('/');
      out.print(result.getInt("roulreward1"));
      out.write(".png> x ");
      ...
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"d3\" type=\"text\" value=\"");
      out.print(result.getInt("roulani2"));
      out.write("\" size=\"6\" maxlength=\"6\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"> -> <br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"d6\" type=\"text\" value=\"");
      out.print(result.getInt("roulreward2"));
      out.write("\" size=\"5\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"> X\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"d16\" type=\"text\" value=\"");
      out.print(result.getInt("roulrewardcnt2"));
      out.write("\" size=\"6\" maxlength=\"6\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"ps5\" type=\"text\" value=\"");
      out.print(result.getString("roulname2"));
      out.write("\" size=\"20\" maxlength=\"20\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br><br><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img src=");
      out.print(imgroot);
      out.write('/');
      ...
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"d4\" type=\"text\" value=\"");
      out.print(result.getInt("roulani3"));
      out.write("\" size=\"6\" maxlength=\"6\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"> -> <br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"d7\" type=\"text\" value=\"");
      out.print(result.getInt("roulreward3"));
      out.write("\" size=\"5\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"> X\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"d17\" type=\"text\" value=\"");
      out.print(result.getInt("roulrewardcnt3"));
      out.write("\" size=\"6\" maxlength=\"6\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"ps6\" type=\"text\" value=\"");
      out.print(result.getString("roulname3"));
      out.write("\" size=\"20\" maxlength=\"20\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br><br><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img src=");
      out.print(imgroot);
      out.write('/');
      ...
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td ");
      out.print(getCheckValueOri(result.getInt("roultimeflag"), -1, "bgcolor=#aaaaaa", ""));
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select name=\"d10\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"-1\" ");
      out.print(getSelect(result.getInt("roultimeflag"), -1));
      out.write(">비활성(-1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"1\" ");
      out.print(getSelect(result.getInt("roultimeflag"),  1));
      out.write(">활성(1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t시간1:<input name=\"d11\" type=\"text\" value=\"");
      out.print(result.getInt("roultimetime1"));
      out.write("\" size=\"3\" maxlength=\"3\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t시간2:<input name=\"d12\" type=\"text\" value=\"");
      out.print(result.getInt("roultimetime2"));
      out.write("\" size=\"3\" maxlength=\"3\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t시간3:<input name=\"d13\" type=\"text\" value=\"");
      out.print(result.getInt("roultimetime3"));
      out.write("\" size=\"3\" maxlength=\"3\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t시간4:<input name=\"d14\" type=\"text\" value=\"");
      out.print(result.getInt("roultimetime4"));
      out.write("\" size=\"3\" maxlength=\"3\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td ");
      out.print(getCheckValueOri(result.getInt("pmgauageflag"), -1, "bgcolor=#aaaaaa", ""));
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select name=\"d20\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"-1\" ");
      out.print(getSelect(result.getInt("pmgauageflag"), -1));
      out.write(">비활성(-1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"1\" ");
      out.print(getSelect(result.getInt("pmgauageflag"),  1));
      out.write(">활성(1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</select><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\tpoint:<input name=\"d21\" type=\"text\" value=\"");
      out.print(result.getInt("pmgauagepoint"));
      out.write("\" size=\"3\" maxlength=\"3\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\tmax:<input name=\"d22\" type=\"text\" value=\"");
      out.print(result.getInt("pmgauagemax"));
      out.write("\" size=\"3\" maxlength=\"3\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<font color=red>Max는 100고정</font>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td ");
      out.print(getCheckValueOri(result.getInt("tsupgradesaleflag"), -1, "bgcolor=#aaaaaa", ""));
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select name=\"d25\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"-1\" ");
      out.print(getSelect(result.getInt("tsupgradesaleflag"), -1));
      out.write(">비활성(-1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"1\" ");
      out.print(getSelect(result.getInt("tsupgradesaleflag"),  1));
      out.write(">활성(1)</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</select><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"d26\" type=\"text\" value=\"");
      out.print(result.getInt("tsupgradesalevalue"));
      out.write("\" size=\"3\" maxlength=\"5\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">%<br>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"ps10\" type=\"text\" value=\"");
      out.print(result.getString("comment"));
      out.write("\" size=\"10\" maxlength=\"128\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input name=\"image\" type=\"image\" src=\"images/btn_send.gif\" border=\"0\" tabindex=\"3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
