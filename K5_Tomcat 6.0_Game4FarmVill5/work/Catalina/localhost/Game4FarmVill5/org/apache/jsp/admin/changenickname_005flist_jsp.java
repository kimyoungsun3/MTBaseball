...
public final class changenickname_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("EUC-KR");
	...
	try{
      ...
      out.write("\t\t\t<form name=\"GIFTFORM\" method=\"post\" action=\"changenickname_list.jsp\" onsubmit=\"return f_Submit(this);\">\r\n");
      out.write("\t\t\t<div  style=\"border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=4>\r\n");
      out.write("\t\t\t\t\t\t\t닉네임 변경 <a href=changenickname_list.jsp><img src=images/refresh2.png alt=\"화면갱신\"></a><br>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      ...
      out.print(gameid);
      out.write("\" maxlength=\"60\" tabindex=\"1\" style=\"border:1px solid #EBEBEB;background:#FFFFFF;width:154px;\"></td>\r\n");
      ...
      out.write("\t\t\t\t\t");
					...
					//2. 데이타 조작
					//exec spu_FarmD 19, 1109, -1, -1, -1, -1,  2, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''						-- 닉네임 정보.
					query.append("{ call dbo.spu_FarmD (?, ?, ?, ?, ?,   ?, ?, ?, ?, ?,   ?, ?, ?, ?, ?,   ?, ?, ?, ?, ?)} ");
					cstmt = conn.prepareCall(query.toString());
					cstmt.setInt(idxColumn++, 19);
					cstmt.setInt(idxColumn++, 1109);
...
while(result.next()){
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><a href=changenickname_list.jsp?gameid=");
      out.print(result.getString("gameid"));
      out.write('>');
      out.print(result.getString("gameid"));
      out.write("</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      out.print(result.getString("oldnickname"));
      out.write(" -> ");
      out.print(result.getString("newnickname"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>");
      ...
      out.write("\t\t\t\t\t\t\t\t<a href=changenickname_list.jsp?idxPage=");
