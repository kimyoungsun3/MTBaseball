...
public final class kfinvite_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("utf-8");
	...
	String kakaouserid 	= util.getParamStr(request, "kakaouuid", "");
	/////////////////////////////////////////////////////////////////////
	//		파라미터 받기
	/////////////////////////////////////////////////////////////////////
	if(DEBUG_LOG_PARAM){
	...
	try{
		...
		query.append("{ call dbo.spu_KakaoFriendInvite (?, ?, ?, ?)} ");
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_KFINVITE); 						msg.append("</code>\n");
