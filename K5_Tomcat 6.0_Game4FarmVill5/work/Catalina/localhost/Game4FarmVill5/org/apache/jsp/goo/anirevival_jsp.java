...
public final class anirevival_jsp extends org.apache.jasper.runtime.HttpJspBase
...
request.setCharacterEncoding("utf-8");
	...
	try{
		...
		//exec spu_AniRevival 'xxxx2', '049000s1i0n7t8445289', 2, 4, -1, -1		-- 병원부활 > 인벤으로 넣기.
		query.append("{ call dbo.spu_AniRevival (?, ?, ?, ?, ?, ?)} ");
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_ANIREVIVAL); 		msg.append("</code>\n");
