/*
exec spu_AniRepReg 'xxxx0', '049000s1i0n7t8445289', 0, -1	-- 없음.
exec spu_AniRepReg 'xxxx', '049000s1i0n7t8445289', 8, -1	-- 소모템.
exec spu_AniRepReg 'xxxx', '049000s1i0n7t8445289', 1, -1	-- 필드동물.
exec spu_AniRepReg 'xxxx', '049000s1i0n7t8445289', 18, -1	 --없는 번호
exec spu_AniRepReg 'xxxx', '049000s1i0n7t8445289', 17, -1	-- 정상(병원).
exec spu_AniRepReg 'xxxx', '049000s1i0n7t8445289', 0, -1	-- 정상(창고).
...
IF OBJECT_ID ( 'dbo.spu_AniRepReg', 'P' ) IS NOT NULL
    DROP PROCEDURE dbo.spu_AniRepReg;
GO

------------------------------------------------
--	1. 프로시져 생성
------------------------------------------------
create procedure dbo.spu_AniRepReg
	@gameid_								varchar(20),
