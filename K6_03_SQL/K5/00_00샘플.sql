...
as
	...
	declare @ITEM_MAINCATEGORY_GOLDTICKET		int					set @ITEM_MAINCATEGORY_GOLDTICKET			= 30	-- 황금티켓.
	declare @ITEM_MAINCATEGORY_BATTLETICKET		int					set @ITEM_MAINCATEGORY_BATTLETICKET			= 31	-- 싸움티켓.
	declare @ITEM_MAINCATEGORY_STEMCELL			int					set @ITEM_MAINCATEGORY_STEMCELL	 			= 1040 	--줄기세포.
	declare @ITEM_MAINCATEGORY_TREASURE			int					set @ITEM_MAINCATEGORY_TREASURE	 			= 1200	-- 보물(1200)
	declare @ITEM_MAINCATEGORY_USERBATTLEBOX	int					set @ITEM_MAINCATEGORY_USERBATTLEBOX		= 37	-- 유저배틀박스(37)
	declare @ITEM_MAINCATEGORY_CASHPOINT		int					set @ITEM_MAINCATEGORY_CASHPOINT			= 39	-- 낙농포인트(39)
	...
	declare @ITEM_SUBCATEGORY_TREASURE			int					set @ITEM_SUBCATEGORY_TREASURE	 			= 1200	-- 보물(1200)
