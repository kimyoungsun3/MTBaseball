...
Begin
	...
	--	end
		...
		begin
			...
			-- 건초(3400)	250
			---------------------------------------------
			exec spu_FVSubGiftSend @GIFTLIST_GIFT_KIND_GIFT, 3100, 50000, '신규가입', @gameid_, ''	-- 코인.
			exec spu_FVSubGiftSend @GIFTLIST_GIFT_KIND_GIFT, 3400, 500, '신규가입', @gameid_, ''	-- 건초.
			exec spu_FVSubGiftSend @GIFTLIST_GIFT_KIND_GIFT, 3300, 50, '신규가입', @gameid_, ''		-- 하트.
			exec spu_FVSubGiftSend @GIFTLIST_GIFT_KIND_GIFT, 3000, 500, '신규가입', @gameid_, ''	-- 울제품.
			exec spu_FVSubGiftSend @GIFTLIST_GIFT_KIND_GIFT, 3001, 500, '신규가입', @gameid_, ''	-- 
			exec spu_FVSubGiftSend @GIFTLIST_GIFT_KIND_GIFT, 3002, 500, '신규가입', @gameid_, ''
			exec spu_FVSubGiftSend @GIFTLIST_GIFT_KIND_GIFT, 3003, 500, '신규가입', @gameid_, ''
			exec spu_FVSubGiftSend @GIFTLIST_GIFT_KIND_GIFT, 3004, 500, '신규가입', @gameid_, ''
