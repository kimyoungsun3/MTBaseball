...
exec spu_FVRoulBuy 'xxxx2', '049000s1i0n7t8445289', 1, 'savedata1', -1, 7776, -1			-- D, C				-- 캐쉬직접
exec spu_FVRoulBuy 'xxxx2', '049000s1i0n7t8445289', 2, 'savedata2', -1, 7777, -1			-- B, A
exec spu_FVRoulBuy 'xxxx2', '049000s1i0n7t8445289', 3, 'savedata3', -1, 7778, -1			-- A, S
exec spu_FVRoulBuy 'xxxx2', '049000s1i0n7t8445289', 4, 'savedata4', -1, 7779, -1			-- A, S (3 + 1)

exec spu_FVRoulBuy 'xxxx2', '049000s1i0n7t8445289',12, 'savedata12', -1, 7777, -1			-- B, A				-- 게임지
exec spu_FVRoulBuy 'xxxx2', '049000s1i0n7t8445289',13, 'savedata13', -1, 7778, -1			-- A, S
exec spu_FVRoulBuy 'xxxx2', '049000s1i0n7t8445289',14, 'savedata14', -1, 7779, -1			-- A, S (3 + 1)

exec spu_FVRoulBuy 'xxxx2', '049000s1i0n7t8445289',22, 'savedata12', -1, 7777, -1			-- B, A				-- 티켓
exec spu_FVRoulBuy 'xxxx2', '049000s1i0n7t8445289',23, 'savedata13', -1, 7778, -1			-- A, S
exec spu_FVRoulBuy 'xxxx2', '049000s1i0n7t8445289',24, 'savedata14', -1, 7779, -1			-- A, S (3 + 1)
*/
...
Begin
	...
	if(@gameid = '')
		...
		BEGIN
			...
			--select 'DEBUG ' + @comment
		END
	else if (@mode_ not in (@MODE_ROULETTE_GRADE1, 	@MODE_ROULETTE_GRADE2, 			@MODE_ROULETTE_GRADE3, 			@MODE_ROULETTE_GRADE4,
													@MODE_ROULETTE_GRADE2_FREE, 	@MODE_ROULETTE_GRADE3_FREE, 	@MODE_ROULETTE_GRADE4_FREE,
													@MODE_ROULETTE_GRADE2_TICKET, 	@MODE_ROULETTE_GRADE3_TICKET, 	@MODE_ROULETTE_GRADE4_TICKET))
		BEGIN
		...
		BEGIN
			...
			if(@tsgauageflag = 1 and @mode_ in (@MODE_ROULETTE_GRADE2, 			@MODE_ROULETTE_GRADE3, 			@MODE_ROULETTE_GRADE4,
				...
				begin
					...
					else if(@mode_ in (@MODE_ROULETTE_GRADE3, @MODE_ROULETTE_GRADE3_TICKET))
						begin
			...
			if(@mode_ in (@MODE_ROULETTE_GRADE1))
			...
			else if(@mode_ in (@MODE_ROULETTE_GRADE3, @MODE_ROULETTE_GRADE3_FREE, @MODE_ROULETTE_GRADE3_TICKET))
				begin
					set @group1 	=    0
					set @group2		=    0
					set @group3		= 9750
					...
					-- 일일 정보수집.
					--------------------------------
					if(@mode_ in (@MODE_ROULETTE_GRADE3, @MODE_ROULETTE_GRADE3_TICKET))
						begin
				...
				begin
					...
					-- 일일 정보수집.
					--------------------------------
					if(@mode_ in (@MODE_ROULETTE_GRADE4, @MODE_ROULETTE_GRADE4_TICKET))
						begin
			...
			---- 마켓필터.
			------------------------------------
			--if(  (@market = @MARKET_SKT    and @version <= 117)
			--	or (@market = @MARKET_GOOGLE and @version <= 117)
			--	or (@market = @MARKET_NHN    and @version <= 117)
			--	or (@market = @MARKET_IPHONE))
			--		begin
			--			set @roul1 = case
			--							when @roul1 = 80015 then 80014
			--							when @roul1 = 80025	then 80024
			--							when @roul1 = 80035	then 80034
			--							when @roul1 = 80045	then 80044
			--							when @roul1 = 80055	then 80054
			--							when @roul1 = 80065	then 80064
			--							else @roul1
			--						end
			--			set @roul2 = case
			--							when @roul2 = 80015 then 80014
			--							when @roul2 = 80025	then 80024
			--							when @roul2 = 80035	then 80034
			--							when @roul2 = 80045	then 80044
			--							when @roul2 = 80055	then 80054
			--							when @roul2 = 80065	then 80064
			--							else @roul2
			--						end
			--			set @roul3 = case
			--							when @roul3 = 80015 then 80014
			--							when @roul3 = 80025	then 80024
			--							when @roul3 = 80035	then 80034
			--							when @roul3 = 80045	then 80044
			--							when @roul3 = 80055	then 80054
			--							when @roul3 = 80065	then 80064
			--							else @roul3
			--						end
			--			set @roul4 = case
			--							when @roul4 = 80015 then 80014
			--							when @roul4 = 80025	then 80024
			--							when @roul4 = 80035	then 80034
			--							when @roul4 = 80045	then 80044
			--							when @roul4 = 80055	then 80054
			--							when @roul4 = 80065	then 80064
			--							else @roul4
			--						end
			--			set @roul5 = case
			--							when @roul5 = 80015 then 80014
			--							when @roul5 = 80025	then 80024
			--							when @roul5 = 80035	then 80034
			--							when @roul5 = 80045	then 80044
			--							when @roul5 = 80055	then 80054
			--							when @roul5 = 80065	then 80064
			--							else @roul5
			--						end
			--		end
			...
			if(@mode_ in (@MODE_ROULETTE_GRADE2, @MODE_ROULETTE_GRADE2_TICKET) and @tsgrade2cnt in (0, 5, 20, 50, 100))
				begin
					--select 'DEBUG 보정2'
					set @rand 	= Convert(int, ceiling(RAND() * 100))
					set @rand2 	= Convert(int, ceiling(RAND() * 100))
			...
			else if(@mode_ in (@MODE_ROULETTE_GRADE3, @MODE_ROULETTE_GRADE3_TICKET) and @tsgrade3cnt in (0, 5, 20, 50, 100))
				begin
					--select 'DEBUG 보정3'
					set @rand 	= Convert(int, ceiling(RAND() * 100))
					set @rand2 	= Convert(int, ceiling(RAND() * 100))
			...
			else if(@mode_ in (@MODE_ROULETTE_GRADE4, @MODE_ROULETTE_GRADE4_TICKET) and @tsgrade4cnt in (0, 5, 20, 50, 100))
				begin
					--select 'DEBUG 보정4-1'
					set @rand 	= Convert(int, ceiling(RAND() * 100))
					set @rand2 	= Convert(int, ceiling(RAND() * 100))
			...
			else if(@mode_ in (@MODE_ROULETTE_GRADE4, @MODE_ROULETTE_GRADE4_TICKET) and @tsgrade4cnt >= 10 and @tsgrade4cnt % 4 = 0)
				begin
					--select 'DEBUG 보정4-2'
					set @rand 	= Convert(int, ceiling(RAND() * 100))
					set @rand2 	= Convert(int, ceiling(RAND() * 100))
	...
	select @nResult_ rtn, @comment comment,
		   ...
		   @roulrewardflag roulrewardflag,	@checktreasure checktreasure, 	@checkreward checkreward, @checkrewardcnt checkrewardcnt,
		...
		begin
			...
			update dbo.tFVUserMaster
				set
					...
					tsgrade2cnt		= tsgrade2cnt + case when (@mode_ in (@MODE_ROULETTE_GRADE2, @MODE_ROULETTE_GRADE2_FREE, @MODE_ROULETTE_GRADE2_TICKET)) then 1 else 0 end,
					tsgrade3cnt		= tsgrade3cnt + case when (@mode_ in (@MODE_ROULETTE_GRADE3, @MODE_ROULETTE_GRADE3_FREE, @MODE_ROULETTE_GRADE3_TICKET)) then 1 else 0 end,
					tsgrade4cnt		= tsgrade4cnt + case when (@mode_ in (@MODE_ROULETTE_GRADE4, @MODE_ROULETTE_GRADE4_FREE, @MODE_ROULETTE_GRADE4_TICKET)) then 1 else 0 end,
					tsgrade2gauage 	= @tsgrade2gauage,	tsgrade3gauage 	= @tsgrade3gauage,	tsgrade4gauage 	= @tsgrade4gauage,
					tsgrade2free	= @tsgrade2free,	tsgrade3free	= @tsgrade3free,	tsgrade4free	= @tsgrade4free
			where gameid = @gameid_
