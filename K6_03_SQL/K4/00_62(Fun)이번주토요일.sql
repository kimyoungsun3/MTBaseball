...
-----------------------------------------------------
--								환생일		 오늘
-- select dbo.fnu_GetSameWeek( @rebirthdate, GETDATE() )
...
BEGIN
	...
	SET     @END_DAY	= CONVERT(varchar, @rebirthdate_ + 7 - DATEPART(dw, CONVERT(varchar, @rebirthdate_, 112)), 112)     -- 이번주 토요일
