...
GO
/*
exec spu_FVUserItemBuyLog 'xxxx2', 10, 90001,     0, 0, 100	-- D, C뽑기 X (1)
exec spu_FVUserItemBuyLog 'xxxx2', 20, 90001,  2000, 0,   0	-- B, A뽑기 X (1)
exec spu_FVUserItemBuyLog 'xxxx2', 30, 90001,  4000, 0,   0	-- A, S뽑기 X (1)
exec spu_FVUserItemBuyLog 'xxxx2', 40, 90001, 12000, 0,   0	-- A, S뽑기 X (3 + 1)

select top  20 * from dbo.tFVUserItemBuyLog where gameid = 'xxxx2' order by idx desc
