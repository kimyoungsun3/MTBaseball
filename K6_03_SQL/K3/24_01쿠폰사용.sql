...
-- select * from dbo.tFVEventCertNoBack where gameid = 'xxxx2'
-- update dbo.tFVUserMaster set market = 5 where gameid = 'xxxx2'
-- update dbo.tFVUserMaster set randserial = -1, itemcode1 = -1, cnt1 = 0, itemcode2 = -1, cnt2 = 0, itemcode3 = -1, cnt3 = 0 where gameid = 'xxxx2'
-- select * from dbo.tFVEventCertNo where kind = 2
-- delete from dbo.tFVGiftList where gameid in ('xxxx2', 'editor1234567890')
-- delete from dbo.tFVEventCertNoBack where gameid in ('xxxx2', 'editor1234567890')

exec spu_FVCheckCertNo 'xxxx2', '049000s1i0n7t8445289', 'E344259F1D0B4FE7', '7771', -1
exec spu_FVCheckCertNo 'xxxx2', '049000s1i0n7t8445289', '168B6A75D3804F47', '7772', -1
exec spu_FVCheckCertNo 'xxxx2', '049000s1i0n7t8445289', 'E2731C6EA8B24DF4', '7773', -1
exec spu_FVCheckCertNo 'xxxx2', '049000s1i0n7t8445289', 'CB459BDD12EA4B71', '7774', -1
exec spu_FVCheckCertNo 'xxxx2', '049000s1i0n7t8445289', '1F087E6589454902', '7775', -1

exec spu_FVCheckCertNo 'xxxx2', '049000s1i0n7t8445289', 'JAYOJAYOFARMVILL', '7777', -1

exec spu_FVCheckCertNo 'xxxx2', '049000s1i0n7t8445289', 'JAYOFARMVILLFREE', '7780', -1
exec spu_FVCheckCertNo 'xxxx2', '049000s1i0n7t8445289', 'JAYOFARMVILLFUN2', '7782', -1
exec spu_FVCheckCertNo 'xxxx2', '049000s1i0n7t8445289', 'JAYOFARMVILLJAM2', '7783', -1
exec spu_FVCheckCertNo 'xxxx2', '049000s1i0n7t8445289', 'JAYOFARMVILLSTRY', '7784', -1


exec spu_FVCheckCertNo 'xxxx2', '049000s1i0n7t8445289', 'ZAYOWAKEJACKPOT7', '7780', -1
*/
use Game4FarmVill3
GO
...
as
	...
	declare @EVENT06_CHECK_ITEM					varchar(16)			set @EVENT06_CHECK_ITEM			= 'ZAYOWAKEJACKPOT7'
	declare @EVENT07_CHECK_ITEM					varchar(16)			set @EVENT07_CHECK_ITEM			= 'NEWZAYOJACKPOT15'
...
Begin
	...
	------------------------------------------------
	set nocount on
	--select 'DEBUG ', @gameid_ gameid_, @password_ password_, @certno_ certno_, @randserial_ randserial_
	...
	select
		@gameid			= gameid,
		@market			= market,
		@eventspot06	= eventspot06,	@eventspot07= eventspot07,	@eventspot08= eventspot08,	@eventspot09= eventspot09,
	...
	if(@gameid = '')
		...
		END
	else if(@certno_ in (@EVENT06_CHECK_ITEM, @EVENT07_CHECK_ITEM, @EVENT08_CHECK_ITEM, @EVENT09_CHECK_ITEM))
		begin
			-- 공통쿠폰 이벤트.
			if(    (@eventspot06 = @EVENT_STATE_YES and @certno_ = @EVENT06_CHECK_ITEM)
				...
				begin
					...
					if(@certno_ = @EVENT06_CHECK_ITEM)
						begin
							-- 1번 결정(3015) 500개, 코인(3100) 50만, 바나나우유(3004)	1500   		JAYOFARMVILLFREE
							set @itemcode1	= 3015
							set @cnt1		=  500
							exec spu_FVSubGiftSend 2, @itemcode1, @cnt1, '발렌타인', @gameid, ''

							set @itemcode2	= 3100
							set @cnt2		= 500000
							exec spu_FVSubGiftSend 2, @itemcode2, @cnt2, '발렌타인', @gameid, ''

							set @itemcode3	= 3004
							set @cnt3		= 1500
							exec spu_FVSubGiftSend 2, @itemcode3, @cnt3, '발렌타인', @gameid, ''
						...
						begin
							-- 2번 바나나우유(3004) 300개, 코인(3100) 30만, 하트(3300) 100	NEWZAYOJACKPOT15
							set @itemcode1	= 3004
							set @cnt1		=  300
							exec spu_FVSubGiftSend 2, @itemcode1, @cnt1, '새학기', @gameid, ''

							set @itemcode2	= 3100
							set @cnt2		= 300000
							exec spu_FVSubGiftSend 2, @itemcode2, @cnt2, '새학기', @gameid, ''

							set @itemcode3	= 3300
							set @cnt3		=  100
							exec spu_FVSubGiftSend 2, @itemcode3, @cnt3, '새학기', @gameid, ''
