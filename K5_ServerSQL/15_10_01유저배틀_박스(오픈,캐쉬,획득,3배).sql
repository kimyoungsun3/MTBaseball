/*
-- delete from dbo.tUserItem where gameid = 'xxxx2' and invenkind = 1040
update dbo.tUserMaster set cashcost = 1000, gamecost = 1000, heart = 0, feed = 0, fpoint = 0 where gameid = 'xxxx2'
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = -1, boxslottime = getdate() where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 11, 22, -1	-- 잘못된모드
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 1, 2, -1		-- 빈곳 > ERROR
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 1, 2, -1		-- 빈곳 > ERROR
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = -1, boxslottime = getdate() where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 2, 1, -1		-- 해당슬롯 미작동.
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = 1, boxslottime = DATEADD(ss, 60*60, getdate()), cashcost = 0 where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 2, 1, -1		-- 캐쉬부족.

-- 오픈모드.
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = -1, boxslottime = getdate() where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 1, 1, -1		-- 오픈모드.

-- 캐쉬모드(시간단축).
--delete from dbo.tUserItem where gameid = 'xxxx2' and invenkind = 1040
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = 1, boxslottime = DATEADD(ss, 60*60, getdate()), cashcost = 1000, gamecost = 0, trophy = 1    where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 2, 1, -1
update dbo.tUserMaster set boxslot1 = 3702, boxslot2 = -1, boxslotidx = 1, boxslottime = DATEADD(ss, 60*60, getdate()), cashcost = 1000, gamecost = 0, trophy = 800  where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 2, 1, -1
update dbo.tUserMaster set boxslot1 = 3703, boxslot2 = -1, boxslotidx = 1, boxslottime = DATEADD(ss, 60*60, getdate()), cashcost = 1000, gamecost = 0, trophy = 2000 where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 2, 1, -1
update dbo.tUserMaster set boxslot1 = 3704, boxslot2 = -1, boxslotidx = 1, boxslottime = DATEADD(ss, 60*60, getdate()), cashcost = 1000, gamecost = 0, trophy = 2000 where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 2, 1, -1
update dbo.tUserMaster set boxslot1 = 3705, boxslot2 = -1, boxslotidx = 1, boxslottime = DATEADD(ss, 60*60, getdate()), cashcost = 1000, gamecost = 0, trophy = 2000 where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 2, 1, -1

-- 획득모드(시간다되어 획득).
--delete from dbo.tUserItem where gameid = 'xxxx2' and invenkind = 1040
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = 1, boxslottime = getdate() - 1, trophy = 1    where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 3, 1, -1
update dbo.tUserMaster set boxslot1 = 3702, boxslot2 = -1, boxslotidx = 1, boxslottime = getdate() - 1, trophy = 800  where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 3, 1, -1
update dbo.tUserMaster set boxslot1 = 3703, boxslot2 = -1, boxslotidx = 1, boxslottime = getdate() - 1, trophy = 2000 where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 3, 1, -1

-- 벨런스테스트.
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = 1, boxslottime = DATEADD(ss, 60*60, getdate()), cashcost = 1000, gamecost = 0, trophy = ( 400 - 1 ), tier = dbo.fun_GetTier( 400 - 1 )  where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 2, 1, -1
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = 1, boxslottime = DATEADD(ss, 60*60, getdate()), cashcost = 1000, gamecost = 0, trophy = ( 800 - 1 ), tier = dbo.fun_GetTier( 800 - 1 )  where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 2, 1, -1
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = 1, boxslottime = DATEADD(ss, 60*60, getdate()), cashcost = 1000, gamecost = 0, trophy = ( 1100 - 1 ), tier = dbo.fun_GetTier( 1100 - 1 )  where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 2, 1, -1
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = 1, boxslottime = DATEADD(ss, 60*60, getdate()), cashcost = 1000, gamecost = 0, trophy = ( 1400 - 1 ), tier = dbo.fun_GetTier( 1400 - 1 )  where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 2, 1, -1
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = 1, boxslottime = DATEADD(ss, 60*60, getdate()), cashcost = 1000, gamecost = 0, trophy = ( 1700 - 1 ), tier = dbo.fun_GetTier( 1700 - 1 )  where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 2, 1, -1
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = 1, boxslottime = DATEADD(ss, 60*60, getdate()), cashcost = 1000, gamecost = 0, trophy = ( 2000 - 1 ), tier = dbo.fun_GetTier( 2000 - 1 )  where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 2, 1, -1
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = 1, boxslottime = DATEADD(ss, 60*60, getdate()), cashcost = 1000, gamecost = 0, trophy = ( 3000 - 1 ), tier = dbo.fun_GetTier( 3000 - 1 )  where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 2, 1, -1
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = 1, boxslottime = DATEADD(ss, 60*60, getdate()), cashcost = 1000, gamecost = 0, trophy = ( 3000     ), tier = dbo.fun_GetTier( 3000     )  where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 2, 1, -1


-- x3모드.
delete from dbo.tUserItem where gameid = 'xxxx2' and invenkind in ( 3, 1040 )
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = 1, cashcost = 1000, gamecost = 0, tier = 3    where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 12, 1, -1
update dbo.tUserMaster set boxslot1 = 3702, boxslot2 = -1, boxslotidx = 1, cashcost = 1000, gamecost = 0, tier = 3  where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 12, 1, -1
update dbo.tUserMaster set boxslot1 = 3703, boxslot2 = -1, boxslotidx = 1, cashcost = 1000, gamecost = 0, tier = 3 where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 12, 1, -1
update dbo.tUserMaster set boxslot1 = 3704, boxslot2 = -1, boxslotidx = 1, cashcost = 1000, gamecost = 0, tier = 3 where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 12, 1, -1
update dbo.tUserMaster set boxslot1 = 3705, boxslot2 = -1, boxslotidx = 1, cashcost = 1000, gamecost = 0, tier = 3 where gameid = 'xxxx2'
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 12, 1, -1

-- 3배모드에서 상인잠금, 오픈 확인.
delete from dbo.tUserItem where gameid = 'xxxx2' and invenkind in ( 3, 1040 )
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = 1, cashcost = 1000, gamecost = 0, tier = 3, tradestate = 1    where gameid = 'xxxx2'	-- 오픈	-> 정상보상
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 12, 1, -1
delete from dbo.tUserItem where gameid = 'xxxx2' and invenkind in ( 3, 1040 )
update dbo.tUserMaster set boxslot1 = 3701, boxslot2 = -1, boxslotidx = 1, cashcost = 1000, gamecost = 0, tier = 3, tradestate = -1    where gameid = 'xxxx2'	-- 잠김 -> 하락보상
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 12, 1, -1

delete from dbo.tUserItem where gameid = 'xxxx2' and invenkind in ( 3, 1040 )
update dbo.tUserMaster set boxslot1 = 3702, boxslot2 = -1, boxslotidx = 1, cashcost = 1000, gamecost = 0, tier = 3, tradestate = 1    where gameid = 'xxxx2'	-- 오픈	-> 정상보상
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 12, 1, -1
delete from dbo.tUserItem where gameid = 'xxxx2' and invenkind in ( 3, 1040 )
update dbo.tUserMaster set boxslot1 = 3702, boxslot2 = -1, boxslotidx = 1, cashcost = 1000, gamecost = 0, tier = 3, tradestate = -1    where gameid = 'xxxx2'	-- 잠김 -> 하락보상
exec spu_BoxOpenMode 'xxxx2', '049000s1i0n7t8445289', 12, 1, -1
...
IF OBJECT_ID ( 'dbo.spu_BoxOpenMode', 'P' ) IS NOT NULL
    DROP PROCEDURE dbo.spu_BoxOpenMode;
GO

------------------------------------------------
--	1. 프로시져 생성
------------------------------------------------
create procedure dbo.spu_BoxOpenMode
