...
exec spu_AniSet 'xxxx', '049000s1i0n7t8445289', '', -1											-- 필드없음.
exec spu_AniSet 'xxxx', '049000s1i0n7t8445289', '3:4', -1										-- 필드1마리.
exec spu_AniSet 'xxxx', '049000s1i0n7t8445289', '0:1;1:3', -1
exec spu_AniSet 'xxxx', '049000s1i0n7t8445289', '0:1;2:3;3:17', -1
...
IF OBJECT_ID ( 'dbo.spu_AniSet', 'P' ) IS NOT NULL
    DROP PROCEDURE dbo.spu_AniSet;
GO

------------------------------------------------
--	1. 프로시져 생성
------------------------------------------------
create procedure dbo.spu_AniSet
	@gameid_								varchar(20),
...
Begin
	...
	if(@nResult_ = @RESULT_SUCCESS)
		BEGIN
			...
			-- 동물 리스트만 보내줌.
			--------------------------------------------------------------
			select fieldidx, listidx from dbo.tUserItem
