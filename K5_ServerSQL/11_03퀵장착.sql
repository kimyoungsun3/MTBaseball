...
exec spu_ItemQuick 'xxxx9', '049000s1i0n7t8445289',  7,-1, -1	-- 총알(해제)
exec spu_ItemQuick 'xxxx9', '049000s1i0n7t8445289',  8, 1, -1	-- 백신
exec spu_ItemQuick 'xxxx9', '049000s1i0n7t8445289',  8,-1, -1	-- 백신(해제)
exec spu_ItemQuick 'xxxx9', '049000s1i0n7t8445289',  9, 1, -1	-- 일꾼
exec spu_ItemQuick 'xxxx9', '049000s1i0n7t8445289',  9,-1, -1	-- 일꾼(해제)
exec spu_ItemQuick 'xxxx9', '049000s1i0n7t8445289', 10, 1, -1	-- 촉진제
exec spu_ItemQuick 'xxxx9', '049000s1i0n7t8445289', 10,-1, -1	-- 촉진제(해제)
*/
use GameMTBaseball
GO

IF OBJECT_ID ( 'dbo.spu_ItemQuick', 'P' ) IS NOT NULL
    DROP PROCEDURE dbo.spu_ItemQuick;
GO

------------------------------------------------
--	1. 프로시져 생성
------------------------------------------------
create procedure dbo.spu_ItemQuick
	@gameid_				varchar(20),
...
as
	...
	declare @ITEM_SUBCATEGORY_VACCINE			int					set @ITEM_SUBCATEGORY_VACCINE 				= 9  -- 백신	(판매[O], 선물[O], 장착[O])
...
Begin
	...
	if(@itemcode != -1)
		begin
			select @subcategory = subcategory from dbo.tItemInfo where itemcode = @itemcode
		end
