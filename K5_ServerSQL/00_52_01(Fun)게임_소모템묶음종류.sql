...
BEGIN
	...
	declare @ITEM_VACCINE_MOTHER				int					set @ITEM_VACCINE_MOTHER					= 802	-- 백신.
	declare @ITEM_VACCINE_SUN1					int					set @ITEM_VACCINE_SUN1						= 803
	declare @ITEM_VACCINE_SUN2					int					set @ITEM_VACCINE_SUN2						= 811
	declare @ITEM_VACCINE_NORMAL_MOTHER			int					set @ITEM_VACCINE_NORMAL_MOTHER				= 801	-- 백신(일반).
	...
	else if(@subcategory_ = @ITEM_SUBCATEGORY_TREASURE_NOR)
		begin
			set @rtn = @ITEM_TREASURE_NOR_MOTHER
		end
	else if(@subcategory_ = @ITEM_SUBCATEGORY_TREASURE_PRE)
		begin
			set @rtn = @ITEM_TREASURE_PRE_MOTHER
		end
