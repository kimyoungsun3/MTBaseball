...
-- 하이요~
-- update dbo.tUserMaster set market = 5, version = 999 where gameid = 'xxxx2'
-- select count(*) from dbo.tUserSaleLog where gameid = 'xxxx2'
-- select * from dbo.tGiftList where gameid = 'xxxx2'
...
set @tradeinfoorg	= '10:2;    11:1;    12:75;    20:10;    30:1;      31:11;         33:7;     34:20;    35:77;  40:-1; 61:-1;       62:1;             63:-1; 70:1;'
...
update dbo.tUserMaster set gamecost = 0, cashcost = 0, feed = 0, heart = 0, adidx = 0, etsalecoin = @etsalecoin, settlestep = 0, goldticket = 99999 where gameid = @gameid
...
update dbo.tUserMaster set gameyear = @gameyear, gamemonth = @gamemonth, frametime = 0, fame = 5, famelv = @famelv, tradecnt = 1, prizecnt = 1 where gameid = @gameid
...
while(@loop <= @loopmax)
	begin
		...
		--select @paramstr paramstr, @tradeinfo tradeinfo
