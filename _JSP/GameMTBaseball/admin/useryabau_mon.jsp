...
<table>
	...
	<tr>
		<td align="center">
			<form name="GIFTFORM" method="post" action="useryabau_mon.jsp" onsubmit="return f_Submit(this);">
			...
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					...
					<tr>
						<td colspan=3>
							<a href=useryabau_mon.jsp?view=0&dateid=<%=dateid%>>그냥보기</a>
							<a href=useryabau_mon.jsp?view=1&dateid=<%=dateid%>>이미지보기</a>
						</td>
					</tr>
				</table>
			</div>
