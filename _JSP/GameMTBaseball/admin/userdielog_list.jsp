...
<table>
	...
	<tr>
		<td align="center">
			<form name="GIFTFORM" method="post" action="userdielog_list.jsp" onsubmit="return f_Submit(this);">
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					<tr>
						<td colspan=4>
							유저 동물죽은 로그
							<a href=userdielog_list.jsp><img src=images/refresh2.png alt="화면갱신"></a>
						</td>
					</tr>
					<tr>
						<td>계정</td>
				...
				<table border=1>
					...
					%>
						<tr>
							...
							<td>여물통상태</td>
							<td>질병상태</td>
							<td><font color=red>죽음상태</a></td>
							<td><font color=red>필요부활석(도움수)</a></td>
							<td><font color=red>죽은시간</a></td>
							<td>머리악세</td>
							<td>꼬리악세</td>
						</tr>
					...
					<%while(result.next()){%>
						<tr>
							...
							<td>
								<a href=userdielog_list.jsp?gameid=<%=result.getString("gameid")%>>
