		...
		<td align="center">
			...
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					<tr>
						<td colspan=4>
							유저들이 하는 부정행위 정보가 들어가 있음 <a href=unusual_list.jsp><img src=images/refresh2.png alt="화면갱신"></a>
						</td>
					</tr>
					<tr>
						<td>부정행위정보들</td>
				...
				<table border=1>
					...
					<%while(result.next()){%>
						<tr>
							...
							<td>
								...
								<a href=usersetting_ok.jsp?p1=19&p2=1005&p3=<%=result.getString("idx")%>&ps1=<%=result.getString("gameid")%>&ps2=<%=adminid%>&branch=unusual_list&gameid=<%=result.getString("gameid")%>>
									삭제
								</a>
							</td>
						</tr>
					...
					<tr>
						<td colspan=5 align=center>
								<a href=unusual_list.jsp?idxPage=<%=(idxPage - 1 < 1)?1:(idxPage-1)%>><<</a>
								<%=idxPage%> / <%=maxPage%>
								<a href=unusual_list.jsp?idxPage=<%=(idxPage + 1 > maxPage)?maxPage:(idxPage + 1)%>>>></a>
						</td>
					</tr>
				</table>
			</div>
