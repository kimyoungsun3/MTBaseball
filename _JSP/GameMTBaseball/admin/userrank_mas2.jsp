		...
		<td align="center">
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					<tr>
						<td colspan=4>
							트로피 순위 1000위 랭킹 <a href=userrank_mas2.jsp><img src=images/refresh2.png alt="화면갱신"></a>
						</td>
					</tr>
				</table>
				<table border=1>
					...
					<%while(result.next()){%>
						<tr>
							...
							<td><a href=userrank_sub2.jsp?dateid=<%=result.getString("dateid")%> target=_blank>보기</a></td>
						</tr>
					<%}%>
				</table>
			</div>
