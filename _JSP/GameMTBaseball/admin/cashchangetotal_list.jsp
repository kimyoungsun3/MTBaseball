...
<table>
	...
	<tr>
		<td align="center">
			<form name="GIFTFORM" method="post" action="cashchangetotal_list.jsp" onsubmit="return f_Submit(this);">
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					<tr>
						<td> 캐쉬환전날자[<%=dateid2%>]</td>
						<td> 검색</td>
				...
				<table border=1>
					...
					<%while(result.next()){%>
						<tr>
							...
							<td><a href=cashchangetotal_list.jsp?dateid=<%=result.getString("dateid")%>><%=result.getString("dateid")%></a></td>
							<td><%=result.getString("cashcost")%></td>
							<td><%=result.getString("gamecost")%></td>
							<td><%=result.getString("changecnt")%></td>
						</tr>
					<%}%>
				</table>
