		...
		<td align="center">
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					<tr>
						<td colspan=4>
							<a href=pcroomearn_day.jsp>돌아가기</a> / 
							<a href=pcroomearn_daysub.jsp>100개로보기</a>
						</td>
					</tr>
				</table>
			</div>
				<table border=1>
					...
					<tr>
						<td colspan=5 align=center>
								<a href=pcroomearn_daysub.jsp?idxPage=<%=(idxPage - 1 < 1)?1:(idxPage-1)%>><<</a>
								<%=idxPage%> / <%=maxPage%>
								<a href=pcroomearn_daysub.jsp?idxPage=<%=(idxPage + 1 > maxPage)?maxPage:(idxPage + 1)%>>>></a>
						</td>
					</tr>
				</table>
