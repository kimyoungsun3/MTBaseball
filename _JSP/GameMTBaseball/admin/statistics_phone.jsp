...
<table>
	...
	<tr>
		<td align="center">
			<form name="GIFTFORM" method="post" action="statistics_phone.jsp" onsubmit="return f_Submit(this);">
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					<tr>
						<td colspan=4>
						유저 유니크 가입체킹(와일드검색은 100건까지)
						</td>
					</tr>
					<tr>
						<td> 폰번호[<%=phone%>]</td>
				...
				<table border=1>
					...
					<%while(result.next()){%>
						<tr>
							...
							<td><a href=statistics_phone.jsp?phone=<%=result.getString("phone")%>><%=result.getString("phone")%></a></td>
							<td><%=getTel(result.getInt("market"))%></td>
							<td><%=result.getString("joincnt")%></td>
