...
<table>
	...
	<tr>
		<td align="center">
			...
			<input type="hidden" name="p2" value="26">
			<input name=branch type=hidden value=blockphone_list2>
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					<tr>
						<td>
							[Push블럭]<br>
							관계사 직원들에게 푸쉬 발송을 방지.(픽토, 카톡 직원들)
						</td>
					</tr>
					<tr>
						<td>
				...
				<table border=1>
					<%
					//2. 데이타 조작
					//exec spu_GameMTBaseballD 19, 25, -1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''					-- 블럭폰리스트
					...
					<%while(result.next()){%>
						<tr>
							...
							<td><a href=usersetting_ok.jsp?p1=19&p2=27&ps3=<%=result.getString("phone")%>&branch=blockphone_list>블랙제거</a></td>
						</tr>
					<%}%>
				</table>
		</td>
