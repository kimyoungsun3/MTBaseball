...
<%
	...
	try{
		...
		//2. 데이타 조작
		//유저세팅변경(19)
		//--exec spu_GameMTBaseballD 30, 32,  1, -1, -1, -1, -1, -1, -1, -1, 'guest90579', 'blackm', '[푸쉬제목]', '[푸쉬내용]', 'LANUCH', '', '', '', '', ''	-- Push 개별.
		//--exec spu_GameMTBaseballD 30, 32,  3, -1, -1, -1, -1, -1, -1, -1, 'guest90579', 'blackm', '[푸쉬제목URL]', '[푸쉬내용URL]', 'http://m.tstore.co.kr', '', '', '', '', ''
		//--exec spu_GameMTBaseballD 30, 33,  1,  5, -1, -1, -1, -1, -1, -1, 'blackm', 'blackm', '[푸쉬제목]', '[푸쉬내용]', 'LANUCH', '', '', '', '', ''		-- Push 전체.
		//--exec spu_GameMTBaseballD 30, 33,  3,  5, -1, -1, -1, -1, -1, -1, 'blackm', 'blackm', '[푸쉬제목URL]', '[푸쉬내용URL]', 'http://m.tstore.co.kr', '', '', '', '', ''
