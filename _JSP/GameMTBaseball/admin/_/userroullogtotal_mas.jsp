...
<table>
	...
	<tr>
		<td align="center">
			<form name="GIFTFORM" method="post" action="userroullogtotal_sub.jsp" onsubmit="return f_Submit(this);">
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table>
					<tr>
						<td colspan=4>
							동물뽑기
							<a href=userroullogtotal_mas.jsp><img src=images/refresh2.png alt="화면갱신"></a>
						</td>
					</tr>
					<tr>
				...
				<table border=1>
					<%
					//2. 데이타 조작
					//exec spu_GameMTBaseballD 19, 411,-1, -1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''						-- 유저 뽑기월토탈 통계
					...
					<%while(result.next()){%>
						<tr>
							...
							<td><a href=userroullogtotal_sub.jsp?dateid=<%=result.getString("dateid8")%>>상세내역보기</a></td>
						</tr>
					<%}%>
				</table>
