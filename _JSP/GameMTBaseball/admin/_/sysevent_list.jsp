		...
		<td align="center">
			...
			<div  style="border:1px solid #D7D6D6;background:#FCFCFC;padding:36px 0;">
				<table border=1 width=1300>
					...
					<%
					//2. 데이타 조작
					//exec spu_GameMTBaseballD 20, 31, 1,  0, -1, -1, -1, -1, -1, -1, '', 'adminid', '2014-05-05 10:00', '2014-05-06 10:00', '상상디지탈', '', '', '', '제목', '내용'	-- 이벤트 글쓰기.
					//exec spu_GameMTBaseballD 20, 31, 2,  0,  1, -1, -1, -1, -1, -1, '', 'adminid', '2014-05-05 10:00', '2014-05-06 10:00', '상상디지탈', '', '', '', '제목2', '내용2'	--        루비.
					//exec spu_GameMTBaseballD 20, 31, 3,  1, -1, -1, -1, -1, -1, -1, '', '', '', '', '', '', '', '', '', ''																--        리스트.
