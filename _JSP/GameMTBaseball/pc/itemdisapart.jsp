...
<%
	...
	try{
		...
		query.append("{ call dbo.spu_ItemDisapart (?, ?, ?, ?, ?, 	?)} ");
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_ITEMDISAPART); 					msg.append("</code>\n");
		...
		msg.append("		<gamecostplus>");	msg.append(result.getInt("gamecostplus"));    	msg.append("</gamecostplus>\n");
		msg.append("	</result>\n");
	    if(resultCode == 1){
	    	//2. 유저 보유 아이템 정보
			//2-3-3. 유저 보유 아이템 정보
