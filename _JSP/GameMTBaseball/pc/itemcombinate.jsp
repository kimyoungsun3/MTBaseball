...
<%
	...
	String listidxpiece	= util.getParamStr(request, "listidxpiece", "-1");
	...
	try{
		...
		//2. 데이타 조작
		//exec spu_ItemCombinate 'mtxxxx3', '049000s1i0n7t8445289', 333, '1:87;2:37;3:88;4:89;', 14, 7721, -1		-- 동헬멧 조각
		query.append("{ call dbo.spu_ItemCombinate (?, ?, ?, ?, ?, 	?, ?)} ");
		cstmt = conn.prepareCall(query.toString());
		cstmt.setString(idxColumn++, gameid);
		cstmt.setString(idxColumn++, password);
		cstmt.setString(idxColumn++, sid);
		cstmt.setString(idxColumn++, listidxpiece);
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_ITEMCOMBINATE); 					msg.append("</code>\n");
		...
		msg.append("		<combinatestate>");	msg.append(result.getInt("combinatestate"));    msg.append("</combinatestate>\n");
		msg.append("		<listidxrtn>");		msg.append(result.getInt("listidxrtn"));    	msg.append("</listidxrtn>\n");
		msg.append("		<itemcode>");		msg.append(result.getInt("itemcode"));    		msg.append("</itemcode>\n");
		msg.append("	</result>\n");
	    if(resultCode == 1){
	    	//2. 유저 보유 아이템 정보
			//2-3-3. 유저 보유 아이템 정보
