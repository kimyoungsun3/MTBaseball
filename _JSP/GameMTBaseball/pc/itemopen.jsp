...
<%
	...
	try{
		...
		//2. 데이타 조작
		//exec spu_ItemOpen 'mtxxxx3', '049000s1i0n7t8445289', 333, 28, 7701, -1
		query.append("{ call dbo.spu_ItemOpen (?, ?, ?, ?, ?, 	?)} ");
		...
		msg.append("<rows>\n");
		msg.append("	<result>\n");
		msg.append("		<code>");			msg.append(PTS_ITEMOPEN); 						msg.append("</code>\n");
		...
		msg.append("		<boxopenmode>");	msg.append(result.getInt("boxopenmode"));    	msg.append("</boxopenmode>\n");
		msg.append("		<openstate>");		msg.append(result.getInt("openstate"));    		msg.append("</openstate>\n");
		msg.append("		<pluscashcost>");	msg.append(result.getInt("pluscashcost"));    	msg.append("</pluscashcost>\n");
		msg.append("	</result>\n");
